自定义构建 Lobe-Chat next 分支镜像

**升级前一定要备份数据**

[Fork](https://github.com/Pigeonszz/lobe-chat/fork) 此项目，启用 actions `upstream-sync` 和 `next-docker-build`
...
Custom build Lobe-Chat next branch docker image

**Always backup before update**

[Fork](https://github.com/Pigeonszz/lobe-chat/fork) the project, enable actions `upstream-sync` and `next-docker-build`
