...
ALTER TABLE "message_groups" DROP CONSTRAINT IF EXISTS "message_groups_topic_id_topics_id_fk";--> statement-breakpoint
...
ALTER TABLE "message_groups" DROP CONSTRAINT IF EXISTS "message_groups_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "message_groups" DROP CONSTRAINT IF EXISTS "message_groups_parent_group_id_message_groups_id_fk";--> statement-breakpoint
...
ALTER TABLE "message_groups" DROP CONSTRAINT IF EXISTS "message_groups_parent_message_id_messages_id_fk";--> statement-breakpoint
...
ALTER TABLE "messages" DROP CONSTRAINT IF EXISTS "messages_message_group_id_message_groups_id_fk";--> statement-breakpoint
