...
ALTER TABLE "resource_permissions" DROP CONSTRAINT IF EXISTS "resource_permissions_workspace_resource_subject_unique";--> statement-breakpoint
ALTER TABLE "resource_permissions" ADD CONSTRAINT "resource_permissions_workspace_resource_subject_unique" UNIQUE NULLS NOT DISTINCT("workspace_id","resource_type","resource_id","user_id");
