...
--> statement-breakpoint
ALTER TABLE "oidc_access_tokens" DROP CONSTRAINT IF EXISTS "oidc_access_tokens_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_authorization_codes" DROP CONSTRAINT IF EXISTS "oidc_authorization_codes_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_consents" DROP CONSTRAINT IF EXISTS "oidc_consents_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_consents" DROP CONSTRAINT IF EXISTS "oidc_consents_client_id_oidc_clients_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_device_codes" DROP CONSTRAINT IF EXISTS "oidc_device_codes_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_grants" DROP CONSTRAINT IF EXISTS "oidc_grants_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_refresh_tokens" DROP CONSTRAINT IF EXISTS "oidc_refresh_tokens_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "oidc_sessions" DROP CONSTRAINT IF EXISTS "oidc_sessions_user_id_users_id_fk";--> statement-breakpoint
