...
ALTER TABLE "nextauth_authenticators" DROP CONSTRAINT IF EXISTS "nextauth_authenticators_user_id_credentialID_pk";--> statement-breakpoint
...
ALTER TABLE "nextauth_accounts" DROP CONSTRAINT IF EXISTS "nextauth_accounts_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "nextauth_authenticators" DROP CONSTRAINT IF EXISTS "nextauth_authenticators_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "nextauth_sessions" DROP CONSTRAINT IF EXISTS "nextauth_sessions_user_id_users_id_fk";--> statement-breakpoint
