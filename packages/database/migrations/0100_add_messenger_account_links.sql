...
CREATE UNIQUE INDEX IF NOT EXISTS "messenger_account_links_platform_user_unique" ON "messenger_account_links" USING btree ("platform","platform_user_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "messenger_account_links_user_platform_unique" ON "messenger_account_links" USING btree ("user_id","platform");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "messenger_account_links_active_agent_idx" ON "messenger_account_links" USING btree ("active_agent_id");
