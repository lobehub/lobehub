...
CREATE UNIQUE INDEX IF NOT EXISTS "project_working_directories_project_instance_unique" ON "project_working_directories" USING btree ("project_id","environment_instance_id");
