...
CREATE INDEX IF NOT EXISTS "search_sync_outbox_dead_idx" ON "search_sync_outbox" USING btree ("dead_at") WHERE "search_sync_outbox"."dead_at" IS NOT NULL;--> statement-breakpoint
