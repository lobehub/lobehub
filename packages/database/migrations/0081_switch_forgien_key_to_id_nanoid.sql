...
ALTER TABLE "rag_eval_dataset_records" DROP CONSTRAINT IF EXISTS "rag_eval_dataset_records_dataset_id_rag_eval_datasets_id_nanoid_fk";--> statement-breakpoint
...
ALTER TABLE "rag_eval_evaluations" DROP CONSTRAINT IF EXISTS "rag_eval_evaluations_dataset_id_rag_eval_datasets_id_nanoid_fk";--> statement-breakpoint
...
ALTER TABLE "rag_eval_evaluation_records" DROP CONSTRAINT IF EXISTS "rag_eval_evaluation_records_dataset_record_id_rag_eval_dataset_records_id_nanoid_fk";--> statement-breakpoint
...
ALTER TABLE "rag_eval_evaluation_records" DROP CONSTRAINT IF EXISTS "rag_eval_evaluation_records_evaluation_id_rag_eval_evaluations_id_nanoid_fk";--> statement-breakpoint
...
ALTER TABLE "rbac_role_permissions" DROP CONSTRAINT IF EXISTS "rbac_role_permissions_role_id_rbac_roles_id_nanoid_fk";--> statement-breakpoint
...
ALTER TABLE "rbac_role_permissions" DROP CONSTRAINT IF EXISTS "rbac_role_permissions_permission_id_rbac_permissions_id_nanoid_fk";--> statement-breakpoint
...
ALTER TABLE "rbac_user_roles" DROP CONSTRAINT IF EXISTS "rbac_user_roles_role_id_rbac_roles_id_nanoid_fk";--> statement-breakpoint
