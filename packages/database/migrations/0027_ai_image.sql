...
ALTER TABLE "generation_batches" DROP CONSTRAINT IF EXISTS "generation_batches_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "generation_batches" DROP CONSTRAINT IF EXISTS "generation_batches_generation_topic_id_generation_topics_id_fk";--> statement-breakpoint
...
ALTER TABLE "generation_topics" DROP CONSTRAINT IF EXISTS "generation_topics_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "generations" DROP CONSTRAINT IF EXISTS "generations_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "generations" DROP CONSTRAINT IF EXISTS "generations_generation_batch_id_generation_batches_id_fk";--> statement-breakpoint
...
ALTER TABLE "generations" DROP CONSTRAINT IF EXISTS "generations_async_task_id_async_tasks_id_fk";--> statement-breakpoint
...
ALTER TABLE "generations" DROP CONSTRAINT IF EXISTS "generations_file_id_files_id_fk";--> statement-breakpoint
