...
--> statement-breakpoint
CREATE TABLE "platform_trial_config" (
...
--> statement-breakpoint
CREATE TABLE "trial_abuse_blocklist" (
	"id" text PRIMARY KEY NOT NULL,
...
ALTER TABLE "organization_team_members" ADD CONSTRAINT "organization_team_members_org_member_id_organization_members_id_fk" FOREIGN KEY ("org_member_id") REFERENCES "public"."organization_members"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_teams" ADD CONSTRAINT "organization_teams_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_trial_config" ADD CONSTRAINT "platform_trial_config_updated_by_user_id_users_id_fk" FOREIGN KEY ("updated_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_trials" ADD CONSTRAINT "user_trials_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "organization_team_members_team_member_uidx" ON "organization_team_members" USING btree ("team_id","org_member_id");--> statement-breakpoint
CREATE UNIQUE INDEX "organization_team_members_member_uidx" ON "organization_team_members" USING btree ("org_member_id");--> statement-breakpoint
CREATE INDEX "organization_team_members_team_id_idx" ON "organization_team_members" USING btree ("team_id");--> statement-breakpoint
CREATE UNIQUE INDEX "organization_teams_org_slug_uidx" ON "organization_teams" USING btree ("org_id","slug");--> statement-breakpoint
CREATE INDEX "organization_teams_org_id_idx" ON "organization_teams" USING btree ("org_id");--> statement-breakpoint
CREATE UNIQUE INDEX "organization_teams_unique_default_idx" ON "organization_teams" USING btree ("org_id") WHERE "organization_teams"."is_default" = true;--> statement-breakpoint
CREATE UNIQUE INDEX "trial_abuse_blocklist_type_value_uidx" ON "trial_abuse_blocklist" USING btree ("fingerprint_type","fingerprint_value");--> statement-breakpoint
CREATE UNIQUE INDEX "user_trials_user_id_uidx" ON "user_trials" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "user_trials_phone_fingerprint_idx" ON "user_trials" USING btree ("phone_fingerprint");--> statement-breakpoint
CREATE INDEX "user_trials_status_idx" ON "user_trials" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "user_wallets_user_id_uidx" ON "user_wallets" USING btree ("user_id");--> statement-breakpoint
ALTER TABLE "model_access_rules" ADD CONSTRAINT "model_access_rules_team_id_organization_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."organization_teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "model_access_rules_team_id_idx" ON "model_access_rules" USING btree ("team_id");--> statement-breakpoint
