...
-- 5. user_memories: title, summary, details, user_id
...
-- 6. chat_groups: title, description, user_id
...
-- 7. user_memories_contexts: title, description, current_status, user_id
...
-- 8. user_memories_preferences: conclusion_directives, suggestions, user_id
...
-- 9. user_memories_activities: notes, narrative, feedback, user_id
...
-- 10. user_memories_identities: description, role, user_id
...
-- 11. user_memories_experiences: situation, reasoning, possible_outcome, action, key_learning, user_id
...
-- 13. documents (large table): title, description, content, slug, user_id, file_type
...
-- 14. messages (largest table): content, user_id, role
