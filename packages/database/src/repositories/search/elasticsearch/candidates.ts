...
import type {
  ...
  ElasticsearchCandidateSearchContext,
...
export const searchElasticsearchCandidates = async (
  { client, indexNamespace }: ElasticsearchCandidateSearchContext,
  ...
  while (shouldContinue) {
    ...
    const response = await client.search({
      ...
      entity,
      index: getSearchIndexAlias(indexNamespace, entity),
