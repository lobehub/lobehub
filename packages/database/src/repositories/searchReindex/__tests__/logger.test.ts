...
import { SearchReindexFileLogger, summarizeSearchReindexError } from '../logger';
...
describe('SearchReindexFileLogger', () => {
  ...
  it('redacts connection URLs and credential assignments from failure summaries', () => {
    const summary = summarizeSearchReindexError(
