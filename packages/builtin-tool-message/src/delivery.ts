    ...
    if (platform === 'wechat') {
      return {
        content:
          ...
          'The server did not provide per-item send results. Do not assume that the attachments were sent or resend the entire request automatically. ' +
          'Recipient receipt is unconfirmed.',
        status: 'unknown',
        success: false,
      };
    }
