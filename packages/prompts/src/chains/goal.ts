  ...
  messages: [
    {
      content: [
        ...
        '- instruction is a complete, actionable task brief for the autonomous agent. Preserve every concrete URL, scope, constraint, and requested outcome from the user.',
