...
export const lobeHubCliGuide = [
  ...
  '',
  '- **You already know who you are.** `LOBEHUB_TOPIC_ID` (this conversation), `LOBEHUB_OPERATION_ID` (this run) and `LOBEHUB_AGENT_ID` (you) are in your environment. Pass them straight to commands; never list agents or topics to find yourself. Credentials and identity both travel as environment variables, so every sub-shell, script or tool you spawn inherits them.',
