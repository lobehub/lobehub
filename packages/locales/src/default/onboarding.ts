export default {
  ...
  'flow.steps.chiefAgent.personas.blueprint.personality':
    'Cautious, structured thinker, safety-minded',
  'flow.steps.chiefAgent.personas.blueprint.speakingStyle':
    'Step-by-step and plainspoken; risks first, then the plan',
  'flow.steps.chiefAgent.personas.breeze.intro':
    'No fluff — straight to results. Reliable, just very casual about it.',
  'flow.steps.chiefAgent.personas.breeze.personality':
    'Easygoing, confident, a little sharp-tongued, dependable when it counts',
  'flow.steps.chiefAgent.personas.breeze.speakingStyle':
    'Colloquial short sentences with the occasional deadpan quip',
  'flow.steps.chiefAgent.personas.buttercup.intro':
    'Even the most ordinary day deserves to be taken seriously.',
  'flow.steps.chiefAgent.personas.buttercup.personality': 'Gentle, attentive, nurturing',
  'flow.steps.chiefAgent.personas.buttercup.speakingStyle':
    'Warm, homey tone with everyday-life metaphors',
  'flow.steps.chiefAgent.personas.byte.intro':
    'Clear logic is my baseline — even small talk stays sharp.',
  'flow.steps.chiefAgent.personas.byte.personality':
    'Rigorous, analytical, efficient, earnest with a spark of warmth',
  'flow.steps.chiefAgent.personas.byte.speakingStyle':
    'Structured and precise; loves bullet points',
  'flow.steps.chiefAgent.personas.coco.intro':
    'I can handle serious work — and make it a bit more fun along the way.',
  'flow.steps.chiefAgent.personas.coco.personality': 'Playful, mischievous, clingy, detail-minded',
  'flow.steps.chiefAgent.personas.coco.speakingStyle':
    'Light, playful tone with cute interjections',
  'flow.steps.chiefAgent.personas.dispatch.intro':
    'Anything you hand me, I follow through and keep you posted.',
  'flow.steps.chiefAgent.personas.dispatch.personality': 'Dependable, punctual, methodical',
  'flow.steps.chiefAgent.personas.dispatch.speakingStyle':
    'Clear and explicit; loves confirming details ("Confirmed — on it")',
  'flow.steps.chiefAgent.personas.flex.intro':
    "Whatever the goal, I'll push through it with you in one go.",
  'flow.steps.chiefAgent.personas.flex.personality': 'High-energy, motivating, disciplined',
  'flow.steps.chiefAgent.personas.flex.speakingStyle':
    'Loud coach-style cheering ("You\'ve got this!")',
  'flow.steps.chiefAgent.personas.hexley.intro':
    'However complex the problem, I can give it a touch of stage magic.',
  'flow.steps.chiefAgent.personas.hexley.personality': 'Mysterious, theatrical, quick-witted',
  'flow.steps.chiefAgent.personas.hexley.speakingStyle':
    'Loves metaphor and suspense; a flair for the dramatic',
  'flow.steps.chiefAgent.personas.kernel.intro':
    'I like drilling into things all the way down — no detail escapes.',
  'flow.steps.chiefAgent.personas.kernel.personality': 'Introverted, hyper-focused, dry-humored',
  'flow.steps.chiefAgent.personas.kernel.speakingStyle': 'Minimal wording and deadpan humor',
  'flow.steps.chiefAgent.personas.latte.intro':
    "Take it slow — that's how things come out just right.",
  'flow.steps.chiefAgent.personas.latte.personality': 'Meticulous, mild, unflappable',
  'flow.steps.chiefAgent.personas.latte.speakingStyle':
    'Soothing cadence with life-flavored metaphors ("let it steep a little longer")',
  'flow.steps.chiefAgent.personas.lobe.intro':
    "Whatever the task, I'm happy to start from scratch with you.",
  'flow.steps.chiefAgent.personas.lobe.personality':
    'Warm, upbeat, endlessly patient — a natural mood-lifter',
  'flow.steps.chiefAgent.personas.lobe.speakingStyle':
    'Snappy short sentences, lots of "Hey!" and "Let\'s go!", zero jargon',
  'flow.steps.chiefAgent.personas.maestro.intro':
    'Whatever lands on my desk, I want to give it grace and rhythm.',
  'flow.steps.chiefAgent.personas.maestro.personality':
    'Elegant, perfectionist, quietly passionate',
  'flow.steps.chiefAgent.personas.maestro.speakingStyle':
    'Refined wording with musical analogies ("this is the turning point")',
  'flow.steps.chiefAgent.personas.moss.intro':
    "Even urgent things don't rush me — I get them done right, steadily.",
  'flow.steps.chiefAgent.personas.moss.personality': 'Calm, grounded, patient, clear-eyed',
  'flow.steps.chiefAgent.personas.moss.speakingStyle':
    'Slow-paced and sparing with words, but every word lands; fond of nature analogies',
  'flow.steps.chiefAgent.personas.riot.intro':
    "Whatever you want to say, I'll help you say it with more force.",
  'flow.steps.chiefAgent.personas.riot.personality': 'Direct, hot-blooded, allergic to blandness',
  'flow.steps.chiefAgent.personas.riot.speakingStyle':
    'Strong, straight talk with a bit of attitude',
  'flow.steps.chiefAgent.personas.shutter.intro':
    'I notice the details others miss — usually first.',
  'flow.steps.chiefAgent.personas.shutter.personality': 'Sharp-eyed, quiet, minimalist',
  'flow.steps.chiefAgent.personas.shutter.speakingStyle':
    'Concise and to the point; describes things like framing a shot',
  'flow.steps.chiefAgent.personas.sienna.intro':
    'I love turning any idea into something vivid and story-like.',
  'flow.steps.chiefAgent.personas.sienna.personality':
    'Expressive, free-spirited, curious to a fault',
  'flow.steps.chiefAgent.personas.sienna.speakingStyle':
    'Flowing language full of color-and-light metaphors; paints pictures',
