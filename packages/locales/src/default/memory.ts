export default {
  ...
  'rules.compose.back': 'Back',
  'rules.compose.blank': 'Write it myself',
  'rules.compose.describeHint':
    'Before writing, ask: strip the page, component and task names — does it still hold?',
  ...
  'rules.compose.generatingFields': 'Working out why, an example and the limits…',
  'rules.compose.generatingGroup': 'Picking a group…',
  'rules.compose.generatingTitle': 'Putting it in one sentence…',
  'rules.compose.how': 'What counts as breaking it (optional)',
  'rules.compose.limits': 'When it does not apply (optional)',
  'rules.compose.needGroup': 'Pick a group before saving.',
  'rules.compose.newGroupProposed': 'New group: {{title}}',
  'rules.compose.next': 'Draft it',
  'rules.compose.noGroup': 'Choose a group',
  'rules.compose.reviewStep': 'Check the draft, change anything, then save',
  ...
  'rules.enforcement.tasteWarning':
    'This one rests on your judgement with nothing hard to check against, so blocking on it may misfire.',
  ...
  'rules.group.back': 'Back',
  'rules.group.blank': 'Fill it in myself',
  'rules.group.describePlaceholder':
    'Say what this group is for, e.g. "engineering rules for open-source repos".',
  ...
  'rules.group.generateFailed': 'Could not draft it. Fill it in yourself.',
  'rules.group.generating': 'Drafting the group…',
  ...
  'rules.origin.generalizedFrom': 'Merged from "{{titles}}"',
  'rules.origin.lastHit': ', last {{time}}',
  'rules.origin.oneOff': 'Looks like a one-off; never being checked is normal',
