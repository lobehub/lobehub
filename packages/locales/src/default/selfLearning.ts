export default {
  ...
  'create.reviewHelp':
    'Here is how it read your brief. Fix anything that is off — these fields decide which conversations it learns from.',
  ...
  'headline.multi.ok': '{{domains}} directions, {{habits}} habits — most of them solid.',
  'headline.multi.recurring':
    '{{domains}} directions, {{habits}} habits, most of them solid — {{count}} recurring problem in “{{name}}”.',
  ...
  'headline.sublineMulti':
    'Lessons take effect as soon as they are learned; correct anything you see wrong',
