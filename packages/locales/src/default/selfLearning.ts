export default {
  ...
  'detail.chart.speculative':
    'This projection is a guess: only {{span}} of one time constant observed (τ = {{tau}}), so the curve has not reached its bend and the ceiling is not pinned down by the data. Run {{n90}} can move at any time.',
  ...
  'detail.chart.trustworthy':
    'At this pace, {{remaining}} more practices to reach 90% (run {{n90}}), and run {{n95}} for 95%. {{span}} time constants observed, so the projection has some ground under it.',
  ...
  'detail.metric.r2': 'Goodness of fit r²',
  'detail.metric.r2Sub': '{{count}} samples',
  'detail.metric.rate': 'Learning rate 1/τ',
  'detail.metric.rateSub': 'τ = {{tau}}',
  ...
  'maturity.reason.low-confidence': 'too few samples or too noisy to fit',
  'maturity.reason.no-data': 'never practised',
  'maturity.reason.pending': 'still computing',
  'maturity.reason.tau-pinned': 'the time constant hit the search ceiling',

  'overview.allDomains': 'All {{count}} expertises',
  'overview.noNumber': 'n/a',
