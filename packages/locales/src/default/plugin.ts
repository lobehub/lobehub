export default {
  ...
  'builtins.builtin-solver.apiName.solve.completed': 'Solved {{pack}}',
  'builtins.builtin-solver.apiName.solve.loading': 'Solving {{pack}} constraints',
  'builtins.builtin-solver.apiName.verify.completed': 'Plan verification',
  'builtins.builtin-solver.apiName.verify.loading': 'Verifying plan',
  'builtins.builtin-solver.inspector.conflicts': '{{count}} conflicts',
  'builtins.builtin-solver.inspector.status.error': 'spec error',
  'builtins.builtin-solver.inspector.status.feasibleTimeout': 'best within time limit',
  'builtins.builtin-solver.inspector.status.infeasible': 'infeasible',
  'builtins.builtin-solver.inspector.status.optimal': 'optimal',
  'builtins.builtin-solver.inspector.verifyFail': 'fail',
  'builtins.builtin-solver.inspector.verifyPass': 'pass',
  'builtins.builtin-solver.render.candidate': 'Candidate {{index}}',
  'builtins.builtin-solver.render.cost.accommodation': 'stay',
  'builtins.builtin-solver.render.cost.meals': 'meals',
  'builtins.builtin-solver.render.cost.transportation': 'transport',
  'builtins.builtin-solver.render.day': 'Day {{day}}',
  'builtins.builtin-solver.render.days': '{{count}} days',
  'builtins.builtin-solver.render.errorTitle': 'Spec validation failed',
  'builtins.builtin-solver.render.feasibleTimeoutNotice':
    'Best plan found within the {{ms}} ms time limit — optimality not proven',
  'builtins.builtin-solver.render.infeasibleTitle': 'No plan satisfies all constraints',
  'builtins.builtin-solver.render.itinerary': 'Day-by-day',
  'builtins.builtin-solver.render.overBudget': 'over budget',
  'builtins.builtin-solver.render.route': 'Route',
  'builtins.builtin-solver.render.satisfiedConstraints': 'Satisfied constraints',
  'builtins.builtin-solver.render.stay': 'Stay',
  'builtins.builtin-solver.render.suggestedRelaxations': 'Suggested relaxations',
  'builtins.builtin-solver.render.timeoutBadge': 'time-limited',
  'builtins.builtin-solver.render.transport': 'Transport',
  'builtins.builtin-solver.render.verifyFail': '{{failed}} of {{total}} checks failed',
  'builtins.builtin-solver.render.verifyPass': 'All checks passed ({{passed}}/{{total}})',
  'builtins.builtin-solver.render.withinBudget': 'within budget',
  'builtins.builtin-solver.title': 'Constraint Solver',
