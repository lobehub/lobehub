export default {
  ...
  'builtins.lobe-task.verify.criteria': 'Criteria',
  'builtins.lobe-task.verify.maxIterations': 'Max iterations',
  'builtins.lobe-task.verify.off': 'Verify gate off',
  'builtins.lobe-task.verify.on': 'Verify gate on',
  'builtins.lobe-task.verify.requirement': 'Acceptance requirement',
  'builtins.lobe-task.verify.rubric': 'Rubric',
  'builtins.lobe-task.verify.verifier': 'Verifier',
