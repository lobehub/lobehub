export default {
  ...
  'builtins.lobe-image-generation.apiName.generateImage.completed': 'Created image',
  'builtins.lobe-image-generation.apiName.generateImage.loading': 'Creating image',
  ...
  'builtins.lobe-image-generation.render.status.elapsed': '{{status}} · {{seconds}}s',
  ...
  'builtins.lobe-video-generation.render.averageDuration': 'Average generation time: {{duration}}',
  ...
  'builtins.lobe-video-generation.render.progress.generating': 'Generating…',
  'builtins.lobe-video-generation.render.progress.longer': 'Taking longer than expected…',
