export default {
  ...
  'channel.connectionError.connection_closed':
    'The platform connection was interrupted. {{appName}} will try to reconnect automatically.',
  ...
  'channel.connectionError.upstream_unavailable':
    'The platform service is temporarily unavailable. {{appName}} will try again later.',
