export default {
  ...
  'transferRequest.acceptedToast': 'Transfer accepted. You are now the owner.',
  ...
  'transferRequest.declinedToast': 'Transfer declined. It stays with its current owner.',
  ...
  'transferRequest.incomingDescWithSessions':
    'Accepting makes you the owner of this agent, and {{name}}’s conversation history with it moves to you as well.',
