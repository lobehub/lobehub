export default {
  ...
  'email.footer.preference':
    'You received this email because of your notification settings on {{appName}}.',
  'email.footer.system': 'This is an important account notification from {{appName}}.',
  ...
  'workspace_waitlist_approved':
    'Your Workspace beta access is ready. Head to Panachat to create your first workspace and invite your team.',
