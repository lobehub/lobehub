export default {
  ...
  'table.columns.trigger.enums.agent_meta': 'Agent Profile',
  ...
  'table.columns.trigger.enums.context_compression': 'Context Compression',
  'table.columns.trigger.enums.cron': 'Scheduled Task',
  'table.columns.trigger.enums.eval': 'Benchmark Eval',
  'table.columns.trigger.enums.expertise': 'Agent Self-Evolution',
  'table.columns.trigger.enums.file_embedding': 'File Embedding',
  'table.columns.trigger.enums.follow_up': 'Follow-up Suggestions',
  'table.columns.trigger.enums.generation_topic_title': 'Generation Topic Title',
  ...
  'table.columns.trigger.enums.prompt_rewrite': 'Prompt Rewrite',
  'table.columns.trigger.enums.provider_check': 'Provider Check',
  ...
  'table.columns.trigger.enums.task': 'Task',
  'table.columns.trigger.enums.thread_title': 'Thread Title',
  'table.columns.trigger.enums.topic': 'Topic Title (Legacy)',
  'table.columns.trigger.enums.topic_summary': 'Topic Summary',
  'table.columns.trigger.enums.topic_title': 'Topic Title',
  'table.columns.trigger.enums.translate': 'Translation',
  'table.columns.trigger.enums.verify': 'Acceptance Check',
