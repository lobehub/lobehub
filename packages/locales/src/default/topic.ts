export default {
  ...
  'newTopic': 'New Topic',
  'projectFromDirectory.actions': 'Project actions for this directory',
  'projectFromDirectory.bind': 'Bind to an existing project…',
  'projectFromDirectory.bindEmpty': 'No projects yet — create one first',
  'projectFromDirectory.bindLoadError': 'Failed to load projects',
  'projectFromDirectory.bindOptionsLoading': 'Loading projects…',
  'projectFromDirectory.create': 'Create project from this directory',
  'projectFromDirectory.loading': 'Checking project…',
  'projectFromDirectory.unbind': 'Unbind from project',
  'projectFromDirectory.view': 'View {{name}}',
