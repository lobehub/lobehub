export default {
  ...
  'heteroAgent.claudeQuota.calendar.dayBurn': 'Burned {{percent}}% of the weekly window',
  ...
  'heteroAgent.claudeQuota.calendar.legendOverPace': 'Faster than even pace',
  ...
  'heteroAgent.claudeQuota.calendar.rateLimited': 'Hit the rate limit',
  'heteroAgent.claudeQuota.calendar.resetAt': 'Window resets at {{time}} (peak {{percent}}%)',
  'heteroAgent.claudeQuota.calendar.title': 'Claude Code usage calendar',
  'heteroAgent.claudeQuota.calendar.usedSoFar': '{{percent}}% used · avg {{daily}}%/day',
