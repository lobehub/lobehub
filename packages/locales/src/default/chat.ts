export default {
  ...
  'workingPanel.files.actions.openInTerminal': 'Open in Terminal',
  'workingPanel.files.actions.paste': 'Paste',
  'workingPanel.files.actions.refresh': 'Refresh',
  'workingPanel.files.actions.rename': 'Rename…',
  'workingPanel.files.delete.confirm': 'Move to {{trash}}',
  'workingPanel.files.delete.confirmTitle': 'Move "{{name}}" to {{trash}}?',
  'workingPanel.files.delete.confirmTitleMultiple': 'Move {{count}} items to {{trash}}?',
  'workingPanel.files.delete.dirtyWarning': 'Includes uncommitted Git changes.',
  'workingPanel.files.delete.fileDesc': 'You can restore it from the {{trash}}.',
  'workingPanel.files.delete.folderDesc':
    '"{{name}}" and everything in it will be moved to the {{trash}}. You can restore them from the {{trash}}.',
  'workingPanel.files.delete.multipleDesc': 'You can restore them from the {{trash}}.',
  'workingPanel.files.feedback.createFailed': 'Couldn\'t create "{{name}}": {{reason}}',
  'workingPanel.files.feedback.deleteFailed': 'Couldn\'t delete "{{name}}": {{reason}}',
  'workingPanel.files.feedback.deviceOffline':
    'The device is offline. Try again after it reconnects.',
  'workingPanel.files.feedback.duplicateFailed': 'Couldn\'t duplicate "{{name}}": {{reason}}',
  'workingPanel.files.feedback.moveConflict': '"{{name}}" already exists in the destination folder',
  'workingPanel.files.feedback.moveFailed': 'Couldn\'t move "{{name}}": {{reason}}',
  'workingPanel.files.feedback.openFailed': 'Couldn\'t open "{{name}}"',
  'workingPanel.files.feedback.pasteFailed': 'Couldn\'t paste "{{name}}": {{reason}}',
  'workingPanel.files.feedback.pasteIntoItself': 'Can\'t paste "{{name}}" into itself',
  'workingPanel.files.feedback.refreshFailed': "Couldn't refresh files",
  'workingPanel.files.feedback.renameFailed': 'Couldn\'t rename "{{name}}": {{reason}}',
  'workingPanel.files.feedback.terminalFailed': "Couldn't open the terminal",
  'workingPanel.files.feedback.trashUnsupported':
    'This device has no {{trash}} to move files to, so nothing was deleted. Delete it on the device itself.',
  'workingPanel.files.feedback.trashed': 'Moved "{{name}}" to {{trash}}',
  'workingPanel.files.feedback.trashedCount': 'Moved {{count}} items to {{trash}}',
  'workingPanel.files.feedback.unsupportedOnDevice':
    "This device's app is out of date. Update it and try again.",
  'workingPanel.files.trashName.linux': 'Trash',
  'workingPanel.files.trashName.mac': 'Trash',
  'workingPanel.files.trashName.windows': 'Recycle Bin',
  'workingPanel.files.validation.empty': 'A file or folder name must be provided',
  'workingPanel.files.validation.exists':
    '"{{name}}" already exists here. Choose a different name.',
  'workingPanel.files.validation.invalidChars':
    'Names can\'t contain < > : " / \\ | ? * or control characters',
  'workingPanel.files.validation.reserved': '"." and ".." can\'t be used as names',
  'workingPanel.files.validation.tooLong': 'Name is too long (255 bytes max)',
