export default {
  ...
  'verifyConfig.configured': 'Acceptance criteria',
  'verifyConfig.criteria': 'Ad-hoc criteria',
  'verifyConfig.criteriaCount': '{{count}} criteria',
  'verifyConfig.criteriaPlaceholder': 'Select ad-hoc criteria',
  'verifyConfig.createCriterion': 'New criterion',
  'verifyConfig.createCriterionTitle': 'Criterion title',
  'verifyConfig.createRubric': 'New rubric',
  'verifyConfig.createRubricTitle': 'Rubric title',
  'verifyConfig.create': 'Create',
  'verifyConfig.disabled': 'Acceptance disabled',
  'verifyConfig.enable': 'Enable acceptance check',
  'verifyConfig.maxIterations': 'Max repair iterations',
  'verifyConfig.modalTitle': 'Delivery Acceptance',
  'verifyConfig.requiredEvidence': 'Required evidence',
  'verifyConfig.reviewAgent': 'Review Agent (built-in by default)',
  'verifyConfig.reviewAgentPlaceholder': 'Use built-in verifier',
  'verifyConfig.rubric': 'Rubric',
  'verifyConfig.rubricPlaceholder': 'Select a rubric',
  'verifyConfig.save': 'Save',
  'verifyConfig.unconfigured': 'Set acceptance criteria',
  'verifyConfig.verifierType': 'Verifier type',
