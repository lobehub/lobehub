export default {
  ...
  'connectAgent.create.title': 'Connect Agents',
  'connectAgent.create.stepDevice':
    'Step 1 of 3 · Choose where your agents run — installed agents will be scanned automatically.',
  'connectAgent.create.stepAgents': 'Step 2 of 3 · Choose agents on {{device}}',
  'connectAgent.create.stepConfirm': 'Step 3 of 3 · Customize agent details',
  ...
  'connectAgent.create.localDeviceDesc': 'Agents run directly on this computer',
  'connectAgent.create.online': 'Online',
  'connectAgent.create.offline': 'Offline',
  'connectAgent.create.noDevices': 'No connected devices',
  'connectAgent.create.noDevicesDesc':
    'Connect a computer to discover and run its installed agents.',
  'connectAgent.create.noDevicesDesktopHint':
    'Install the desktop app and sign in to connect automatically',
  'connectAgent.create.downloadDesktop': 'Download desktop app',
  'connectAgent.create.download': 'Download',
  'connectAgent.create.connectCli': 'Connect from the command line',
  ...
  'connectAgent.create.scanning': 'Scanning this device for agents…',
  'connectAgent.create.scanFailed': 'Scan failed',
  'connectAgent.create.rescan': 'Rescan',
  'connectAgent.create.rescanDevice': 'Scan again',
  'connectAgent.create.noneDetected': 'No supported agents detected',
  'connectAgent.create.noneDetectedHint':
    'Install a supported agent on this device, then scan again. For example:',
  'connectAgent.create.detectedCount': 'Select the agents you want to connect ({{total}} found).',
  'connectAgent.create.notInstalled': 'Not installed',
  'connectAgent.create.selectFirst': 'Select at least one agent to continue',
  'connectAgent.create.customizeName': 'Customize details…',
  'connectAgent.create.connect': 'Connect selected agents',
  ...
  'connectAgent.create.detectedInScan': 'Available on this device',
  'connectAgent.create.back': 'Back',
  'connectAgent.create.createFailed': 'Connection failed',
  'connectAgent.create.doneTitle': '{{name}} is connected',
  'connectAgent.create.doneTitleMany': '{{total}} agents connected',
  'connectAgent.create.doneHint': 'All set. Open an agent to give it its first task.',
  'connectAgent.create.openChat': 'Open chat',
  'connectAgent.create.done': 'Done',
  'connectAgent.providerDesc.claude-code': 'Agentic coding tool',
  'connectAgent.providerDesc.codebuddy': 'Your intelligent coding companion',
  'connectAgent.providerDesc.codex': 'AI coding partner',
  'connectAgent.providerDesc.amp': 'The frontier agent',
  'connectAgent.providerDesc.opencode': 'The open-source AI coding agent',
  'connectAgent.providerDesc.pi': 'Minimal agent harness',
  'connectAgent.providerDesc.qoder': 'Terminal-native AI coding partner',
  'connectAgent.providerDesc.openclaw': 'Multi-channel gateway for AI agents',
  'connectAgent.providerDesc.hermes': 'Self-improving AI agent',
