export default {
  ...
  'settingChatAppearance.linkIcon.desc':
    'Show a website icon before links in messages. Turn this off if links look oversized when copied into email or other apps.',
  'settingChatAppearance.linkIcon.title': 'Link Icon',
