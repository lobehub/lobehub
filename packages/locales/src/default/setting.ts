...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.billingPage.usage.quota.resetsIn_one': 'Resets in {{count}} day',
  'workspace.billingPage.usage.quota.resetsIn_other': 'Resets in {{count}} days',
  'workspace.billingPage.usage.quota.resetsToday': 'Resets today',
