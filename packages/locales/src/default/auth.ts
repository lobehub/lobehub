export default {
  ...
  'betterAuth.signin.emailLabel': 'Email address',
  ...
  'betterAuth.signin.nextStep': 'Continue',
  ...
  'betterAuth.signin.phone.submitOtp': 'Sign in',
  'betterAuth.signin.phone.title': 'Sign in with phone',
  'betterAuth.signin.phone.useEmail': 'Use email instead',
  ...
  'betterAuth.signin.signupLink': 'Sign up',
  ...
  'betterAuth.signin.submit': 'Continue',
  'betterAuth.signup.confirmPasswordLabel': 'Confirm password',
  'betterAuth.signup.confirmPasswordPlaceholder': 'Confirm your password',
  'betterAuth.signup.emailLabel': 'Email address',
  ...
  'betterAuth.signup.lastNameLabel': 'Last name',
  'betterAuth.signup.lastNamePlaceholder': 'Last name',
  'betterAuth.signup.optional': 'Optional',
  'betterAuth.signup.passwordLabel': 'Password',
  'betterAuth.signup.passwordPlaceholder': 'Create a password',
  'betterAuth.signup.referralCodePlaceholder': 'Referral code (optional)',
  'betterAuth.signup.signinLink': 'Sign in',
  'betterAuth.signup.submit': 'Continue',
  ...
  'betterAuth.signup.cardTitle': 'Sign Up',
  'betterAuth.signup.title': 'Sign Up',
  ...
  'betterAuth.verifyPhone.otp.changePhone': 'Use a different number',
  'betterAuth.verifyPhone.otp.description': 'Enter the 6-digit code sent to {{phone}}',
  'betterAuth.verifyPhone.otp.length': 'Code must be 6 digits',
  'betterAuth.verifyPhone.otp.required': 'Please enter the verification code',
  ...
  'betterAuth.verifyPhone.success': 'Phone number verified',
  'betterAuth.verifyPhone.title': 'Activate trial — verify phone',
  ...
  'legal.back': 'Back',
  'legal.privacy.intro':
    'This Privacy Policy explains how {{orgName}} (“we”, “us”) collects, uses, and protects information when you use {{appName}}.',
  'legal.privacy.sections.changes.body':
    'We may update this Privacy Policy from time to time. The “last updated” date will change when we do. Continued use of {{appName}} after an update means you accept the revised policy.',
  'legal.privacy.sections.changes.title': 'Changes',
  'legal.privacy.sections.collect.body':
    'We may collect account details you provide (such as name, email, phone number), usage and diagnostic data needed to operate the service, content you submit to {{appName}}, and payment or billing information when you purchase paid features.',
  'legal.privacy.sections.collect.title': 'Information we collect',
  'legal.privacy.sections.contact.body': 'For privacy questions, contact {{orgName}}.',
  'legal.privacy.sections.contact.bodyWithEmail':
    'For privacy questions, contact {{orgName}} at {{supportEmail}}.',
  'legal.privacy.sections.contact.title': 'Contact',
  'legal.privacy.sections.overview.body':
    'We process personal data to provide {{appName}}, keep accounts secure, improve the product, and meet legal obligations. We do not sell your personal information.',
  'legal.privacy.sections.overview.title': 'Overview',
  'legal.privacy.sections.retention.body':
    'We retain information only as long as needed for the purposes described in this policy, unless a longer period is required by law. You may request deletion of your account subject to legal and operational limits.',
  'legal.privacy.sections.retention.title': 'Retention',
  'legal.privacy.sections.rights.body':
    'Depending on your location, you may have rights to access, correct, delete, or export your personal data, or to object to certain processing. Contact us to exercise these rights.',
  'legal.privacy.sections.rights.title': 'Your rights',
  'legal.privacy.sections.security.body':
    'We use industry-standard safeguards to protect your data. No method of transmission or storage is completely secure, and we cannot guarantee absolute security.',
  'legal.privacy.sections.security.title': 'Security',
  'legal.privacy.sections.share.body':
    'We may share information with service providers who help us operate {{appName}} (for example hosting, analytics, or payment processors), when required by law, or as part of a merger or acquisition. Providers may only process data on our instructions.',
  'legal.privacy.sections.share.title': 'How we share information',
  'legal.privacy.sections.use.body':
    'We use information to create and manage your account, provide AI and collaboration features, process payments, prevent abuse, troubleshoot issues, and communicate service-related notices.',
  'legal.privacy.sections.use.title': 'How we use information',
  'legal.privacy.title': 'Privacy Policy',
  'legal.privacy.updated': 'Last updated: 2026-08-06',
  'legal.terms.intro':
    'Welcome to {{appName}}. These Terms of Service (“Terms”) are a binding agreement between you and {{orgName}} (“we”, “us”) governing your access to and use of {{appName}} and related services (the “Service”). By using the Service, you agree to these Terms.',
  'legal.terms.sections.acceptableUse.body':
    'You may not use the Service for illegal, harmful, abusive, or deceptive activity; to infringe others’ rights; to attempt unauthorized access; or to interfere with the Service’s security or availability. We may suspend or terminate access for violations.',
  'legal.terms.sections.acceptableUse.title': 'Acceptable use',
  'legal.terms.sections.acceptance.body':
    'By creating an account or otherwise using {{appName}}, you confirm that you have read, understood, and agree to these Terms and our Privacy Policy. If you do not agree, do not use the Service.',
  'legal.terms.sections.acceptance.title': 'Acceptance of terms',
  'legal.terms.sections.account.body':
    'You must provide accurate account information and keep your credentials secure. You are responsible for activity under your account. Notify us promptly of any unauthorized use.',
  'legal.terms.sections.account.title': 'Accounts',
  'legal.terms.sections.changes.body':
    'We may update these Terms from time to time. The “last updated” date will change when we do. Continued use of the Service after an update means you accept the revised Terms.',
  'legal.terms.sections.changes.title': 'Changes',
  'legal.terms.sections.contact.body': 'Questions about these Terms can be sent to {{orgName}}.',
  'legal.terms.sections.contact.bodyWithEmail':
    'Questions about these Terms can be sent to {{orgName}} at {{supportEmail}}.',
  'legal.terms.sections.contact.title': 'Contact',
  'legal.terms.sections.content.body':
    'You retain ownership of content you submit. You grant us a license to host, process, and display that content as needed to operate the Service. You are responsible for ensuring you have the rights to submit the content you provide.',
  'legal.terms.sections.content.title': 'Content',
  'legal.terms.sections.disclaimer.body':
    'The Service is provided “as is” without warranties of any kind, to the fullest extent permitted by law. AI-generated output may be inaccurate or incomplete; you must review it before relying on it.',
  'legal.terms.sections.disclaimer.title': 'Disclaimer',
  'legal.terms.sections.privacy.body':
  ...
  'legal.terms.sections.privacy.title': 'Privacy',
  'legal.terms.sections.service.body':
    '{{appName}} provides AI-assisted tools and related features. Features may change over time. We may modify, suspend, or discontinue parts of the Service with reasonable notice when practical.',
  'legal.terms.sections.service.title': 'The Service',
  'legal.terms.title': 'Terms of Service',
  'legal.terms.updated': 'Last updated: 2026-08-06',
