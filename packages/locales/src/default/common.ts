export default {
  ...
  'messengerBanner.title': 'Talk to Panachat AI on your favorite messaging apps',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use {{cloudName}}.',
  ...
  'cmdk.askLobeAI': 'Ask Panachat AI',
  ...
  'taskTemplate.action.create.success': 'Scheduled task added. Find it in Panachat AI.',
  ...
  'upgradeVersion.buildChannel': '{{channel}}',
  'upgradeVersion.gitSha': '{{sha}}',
  'upgradeVersion.builtAt': 'Built {{time}}',
  'upgradeVersion.shaCopied': 'Commit SHA copied',
