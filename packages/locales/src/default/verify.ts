export default {
  ...
  'acceptance.workspace.actions.archive': 'Archive',
  'acceptance.workspace.actions.deleteNow': 'Delete now',
  'acceptance.workspace.actions.unarchive': 'Unarchive',
  'acceptance.workspace.archive.banner':
    'Archived acceptances are deleted after 30 days, including every round and evidence file. Unarchive at any time to restore.',
  'acceptance.workspace.archive.daysLeft': 'cleaned up in {{count}} days',
  'acceptance.workspace.archive.error': 'Failed to archive acceptance',
  'acceptance.workspace.archive.rounds': '{{count}} rounds',
  'acceptance.workspace.archive.success': 'Archived. Cleaned up automatically in 30 days.',
  'acceptance.workspace.archive.unarchiveError': 'Failed to unarchive acceptance',
  'acceptance.workspace.archive.unarchiveSuccess': 'Acceptance restored',
  'acceptance.workspace.batch.accept': 'Accept',
  'acceptance.workspace.batch.archive': 'Archive',
  'acceptance.workspace.batch.archiveSuccess': '{{count}} acceptance(s) archived',
  ...
  'acceptance.workspace.filters.archived': 'Archived',
  'acceptance.workspace.filters.empty.archived':
    'Archived acceptances stay here for 30 days, then are cleaned up together with their evidence files.',
  'acceptance.workspace.filters.empty.archivedTitle': 'No archived acceptances',
