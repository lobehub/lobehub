export default {
  ...
  'acceptance.actions.confirmReject': 'Reject and continue repair',
  'acceptance.actions.reject': 'Reject delivery',
  'acceptance.accept.description':
    'This closes the acceptance and archives all verification rounds as evidence. You are accepting with {{count}} remaining exception(s).',
  'acceptance.actionError': 'The acceptance could not be updated. Try again.',
  'acceptance.checks.fixed': 'Fixed',
  'acceptance.checks.gate': 'Gate',
  ...
  'acceptance.exceptionCount': '{{count}} exception(s) in the final results',
  ...
  'acceptance.reject.required': 'Enter a reason before rejecting the delivery.',
  'acceptance.round': 'Round {{round}}',
  'acceptance.roundCount': '{{count}} verification round(s)',
  'acceptance.roundShort': 'R{{round}}',
  'acceptance.rounds.title': 'Round history',
