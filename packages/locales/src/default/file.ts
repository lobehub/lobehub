export default {
  'officeEditor.downloadRecovery': 'Download recovery copy',
  'officeEditor.retrySave': 'Retry save',
  'officeEditor.saveFailed': 'Save failed',
  'addFolder': 'Create Folder',
  'addLibrary': 'Add',
  'addPage': 'Create Page',
  'docxEditor.actions.addLink': 'Add link',
  'docxEditor.actions.addParagraph': 'Add paragraph',
  'docxEditor.actions.addTable': 'Add table',
  'docxEditor.actions.align.center': 'Align center',
  'docxEditor.actions.align.justify': 'Justify',
  'docxEditor.actions.align.left': 'Align left',
  'docxEditor.actions.align.right': 'Align right',
  'docxEditor.actions.bold': 'Bold',
  'docxEditor.actions.bulletList': 'Bulleted list',
  'docxEditor.actions.copy': 'Copy paragraph',
  'docxEditor.actions.deleteBlock': 'Delete block',
  'docxEditor.actions.download': 'Download',
  'docxEditor.actions.editLink': 'Edit link text',
  'docxEditor.actions.fontFamily': 'Font',
  'docxEditor.actions.fontSize': 'Font size',
  'docxEditor.actions.insertImage': 'Insert image',
  'docxEditor.actions.numberedList': 'Numbered list',
  'docxEditor.actions.paste': 'Paste as paragraph',
  'docxEditor.actions.redo': 'Redo',
  'docxEditor.actions.replaceImage': 'Replace image',
  'docxEditor.actions.save': 'Save',
  'docxEditor.actions.style': 'Paragraph style',
  'docxEditor.actions.undo': 'Undo',
  'docxEditor.defaults.listItem': 'List item',
  'docxEditor.defaults.paragraph': 'New paragraph',
  'docxEditor.prompts.linkTarget': 'Link URL',
  'docxEditor.prompts.linkText': 'Link text',
  'docxEditor.prompts.tableColumn': 'Column number',
  'docxEditor.prompts.tableRow': 'Row number',
  'docxEditor.prompts.tableText': 'Cell text',
  'docxEditor.status.failed': 'Save failed',
  'docxEditor.status.saved': 'Saved',
  'docxEditor.status.saving': 'Saving…',
  'docxEditor.status.unsaved': 'Unsaved changes',
  'docxEditor.fonts.default': 'Default font',
  'docxEditor.sizes.default': 'Size',
  'docxEditor.styles.heading1': 'Heading 1',
  'docxEditor.styles.heading2': 'Heading 2',
  'docxEditor.styles.heading3': 'Heading 3',
  'docxEditor.styles.normal': 'Normal',
  ...
  'pptxEditor.actions.addChart': 'Add chart',
  'pptxEditor.actions.addImage': 'Add image',
  'pptxEditor.actions.addShape': 'Add shape',
  'pptxEditor.actions.addText': 'Add text',
  'pptxEditor.actions.align.ctr': 'Align center',
  'pptxEditor.actions.align.l': 'Align left',
  'pptxEditor.actions.align.r': 'Align right',
  'pptxEditor.actions.bold': 'Bold',
  'pptxEditor.actions.deleteElement': 'Delete element',
  'pptxEditor.actions.deleteSlide': 'Delete slide',
  'pptxEditor.actions.download': 'Download',
  'pptxEditor.actions.duplicateSlide': 'Duplicate slide',
  'pptxEditor.actions.editChart': 'Edit chart',
  'pptxEditor.actions.editText': 'Edit text',
  'pptxEditor.actions.layout': 'Slide layout',
  'pptxEditor.actions.redo': 'Redo',
  'pptxEditor.actions.resize': 'Resize',
  'pptxEditor.actions.save': 'Save',
  'pptxEditor.actions.undo': 'Undo',
  'pptxEditor.defaults.text': 'New text',
  'pptxEditor.errors.chartData': 'Enter the same number of valid categories and values.',
  'pptxEditor.layout': 'Slide {{index}}',
  'pptxEditor.prompts.chartCategories': 'Chart categories, separated by commas',
  'pptxEditor.prompts.chartValues': 'Chart values, separated by commas',
  'pptxEditor.prompts.text': 'Text',
  'pptxEditor.status.saved': 'Saved',
  'pptxEditor.status.failed': 'Save failed',
  'pptxEditor.status.saving': 'Saving…',
  'pptxEditor.status.unsaved': 'Unsaved changes',
  ...
  'xlsxEditor.actions.addSheet': 'Add worksheet',
  'xlsxEditor.actions.alignCenter': 'Align center',
  'xlsxEditor.actions.alignLeft': 'Align left',
  'xlsxEditor.actions.alignRight': 'Align right',
  'xlsxEditor.actions.bold': 'Bold',
  'xlsxEditor.actions.clear': 'Clear contents',
  'xlsxEditor.actions.copy': 'Copy',
  'xlsxEditor.actions.deleteColumn': 'Delete column',
  'xlsxEditor.actions.deleteRow': 'Delete row',
  'xlsxEditor.actions.deleteSheet': 'Delete worksheet',
  'xlsxEditor.actions.download': 'Download',
  'xlsxEditor.actions.insertColumn': 'Insert column',
  'xlsxEditor.actions.insertRow': 'Insert row',
  'xlsxEditor.actions.italic': 'Italic',
  'xlsxEditor.actions.moveSheetLeft': 'Move worksheet left',
  'xlsxEditor.actions.moveSheetRight': 'Move worksheet right',
  'xlsxEditor.actions.numberFormat': 'Format',
  'xlsxEditor.actions.paste': 'Paste',
  'xlsxEditor.actions.redo': 'Redo',
  'xlsxEditor.actions.save': 'Save',
  'xlsxEditor.actions.undo': 'Undo',
  'xlsxEditor.formats.currency': 'Currency',
  'xlsxEditor.formats.general': 'General',
  'xlsxEditor.formats.number': 'Number',
  'xlsxEditor.formats.percent': 'Percent',
  'xlsxEditor.prompts.deleteSheet': 'Delete worksheet "{{name}}"?',
  'xlsxEditor.prompts.renameSheet': 'Worksheet name',
  'xlsxEditor.status.saved': 'Saved',
  'xlsxEditor.status.failed': 'Save failed',
  'xlsxEditor.status.saving': 'Saving…',
  'xlsxEditor.status.unsaved': 'Unsaved changes',
