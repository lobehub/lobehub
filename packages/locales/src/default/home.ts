export default {
  ...
  'dashboard.customize.decrease': 'Decrease',
  'dashboard.customize.entry': 'Customize',
  'dashboard.customize.increase': 'Increase',
  ...
  'dashboard.customize.recents.count.desc': 'How many recent threads Home lists.',
  'dashboard.customize.recents.count.title': 'Threads shown',
  'dashboard.customize.recents.desc': 'Control the recent threads list on Home.',
  'dashboard.customize.reset': 'Reset to defaults',
  'dashboard.customize.rightBar.desc': 'Control the decoration and widgets shown on Home.',
  'dashboard.customize.tab.recents': 'Recent threads',
  'dashboard.customize.tab.rightBar': 'Right bar',
  'dashboard.customize.tab.tasks': 'Tasks',
  'dashboard.customize.tasks.count.desc': 'How many tasks Home lists.',
  'dashboard.customize.tasks.count.title': 'Tasks shown',
  'dashboard.customize.tasks.desc': 'Control the task list on Home.',
  ...
  'dashboard.customize.widgets.desc': 'Choose which sections appear in the right bar.',
  'dashboard.customize.widgets.title': 'Widgets',
