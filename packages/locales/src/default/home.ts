export default {
  ...
  'dashboard.greeting.subtitle': 'What would you like your Inbox agent to handle?',
  'dashboard.mode.chat': 'Chat',
  'dashboard.mode.note': 'Note',
  'dashboard.mode.task': 'Task',
  'dashboard.note.empty': 'No pages yet',
  'dashboard.note.noContent': 'No content yet',
  'dashboard.note.title': 'Pages',
