export default {
  ...
  'dashboard.customize.rightBar.desc': 'Control the decoration and sections shown on Home.',
  'dashboard.customize.tab.recents': 'Recent threads',
  'dashboard.customize.tab.rightBar': 'Sections',
  ...
  'dashboard.customize.widgets.desc': 'Choose which sections appear on Home.',
  'dashboard.customize.widgets.title': 'Sections shown',
