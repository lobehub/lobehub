/**
 * LobeHub provider model descriptions (provider-scoped i18n keys).
 *
 * Generated by:
 *   bun run .agents/skills/add-model/scripts/sync-lobehub-model-locales.ts
 *
 * Do not edit by hand — update `.local-config/model-config/**` descriptions and re-run the script.
