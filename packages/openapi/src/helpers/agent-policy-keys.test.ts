...
import { retainAgentPermissionPolicies } from './agent-policy-keys';

describe('retainAgentPermissionPolicies', () => {
  it('keeps the member permission policies when the column is cleared', () => {
    ...
    // owner's alone — a clear must not become a way around that.
    expect(
