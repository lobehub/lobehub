...
'- For associatedSubjects and associatedObjects, the following fields are REQUIRED:',
'  - name (string) - REQUIRED',
'  - type (string) - REQUIRED',
'  - extra (string or null) - REQUIRED, use null if no extra metadata',
'- labels field in withContext is REQUIRED, use empty array [] if no labels',
'\n',
  '\n',
