export const identityPrompt = [
  ...
  '\n',
  '- Use `actions.add` for genuinely new identity aspects that are',
  ...
  '- Use `actions.update` when an existing entry changes or gains',
  ...
  '- Use `actions.remove` to remove incorrect, obsolete, or',
  '  duplicated entries.',
  '\n',
  ...
  '4. Return exactly `{ "actions": { "add": [], "update": [], "remove": [] } }`, filling the arrays with actions when needed',
