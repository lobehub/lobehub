...
- For step-by-step platform setup instructions, read the platform-specific reference: \`references/bot-discord\`, \`references/bot-telegram\`, \`references/bot-slack\`, \`references/bot-feishu\`, \`references/bot-lark\`, \`references/bot-qq\`, or \`references/bot-wechat\`
`;
