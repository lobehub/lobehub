...
const TaskInstruction = memo(() => {
  ...
  return (
    <Flexbox gap={4}>
      ...
      />
      {/* The editTask tool can update instructions while this detail stays mounted. EditorCanvas
          normally ignores same-entity updates to protect autosave focus, so opt in here. */}
      <EditorCanvas
        syncExternalContent
