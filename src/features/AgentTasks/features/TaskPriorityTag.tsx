...
const TaskPriorityTag = memo<TaskPriorityTagProps>(({ size = 16, priority, taskIdentifier }) => {
  ...
  if (loading)
    return <Icon spin color={cssVar.colorTextDescription} icon={Loader2Icon} size={size} />;
