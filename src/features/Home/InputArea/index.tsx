      ...
      <Flexbox ref={chatInputRef}>
        ...
        {showInputBanners && (
          <InputBannerQueue>
            ...
            {/* The banner advertises talking to the assistant from Discord /
                Slack / Telegram / WeChat, which is the same set of external
                integrations gated elsewhere — offering it where none are
                configured sends users to set up a channel that cannot
                connect. */}
