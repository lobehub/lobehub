...
const GoalDetailActions = memo<GoalDetailActionsProps>(
  ({ agentId, goalId, onDeleted, projectId }) => {
    ...
    const items = useMemo<DropdownItem[]>(
      ...
      [agentId, canEditTask, deleteGoal, goalId, navigate, onDeleted, projectId, shareUrl, t],
    );
