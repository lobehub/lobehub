...
const translations: Record<string, string> = {
  ...
  'ModelSwitchPanel.detail.pricing.credit.input': 'Input {{amount}} credits/M tokens',
  'ModelSwitchPanel.detail.pricing.credit.output': 'Output {{amount}} credits/M tokens',
  'ModelSwitchPanel.detail.pricing.creditPerImage': '~ {{amount}} credits / image',
  'ModelSwitchPanel.detail.pricing.creditPerVideo': '~ {{amount}} credits / video',
  'ModelSwitchPanel.detail.pricing.creditUnitSuffix.image': 'credits/img',
  'ModelSwitchPanel.detail.pricing.creditUnitSuffix.millionTokens': 'credits/M tokens',
