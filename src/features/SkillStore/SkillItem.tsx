...
const SkillItem = memo<SkillItemProps>(
  ({ icon, identifier, isConnected, label, serverName, type }) => {
    ...
    const renderAction = () => {
      ...
      if (isConnected) {
        return <ActionIcon icon={Unplug} onClick={handleDisconnect} />;
      }

      return <ActionIcon icon={Plus} onClick={handleConnect} />;
    };
