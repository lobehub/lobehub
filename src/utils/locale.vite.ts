...
const antdLocaleLoaders = import.meta.glob(
  '/node_modules/antd/es/locale/{ar_EG,bg_BG,de_DE,en_US,es_ES,fa_IR,fr_FR,it_IT,ja_JP,ko_KR,nl_NL,pl_PL,pt_BR,ru_RU,tr_TR,vi_VN}.js',
);

const FALLBACK_ANTD_LOCALE = '/node_modules/antd/es/locale/en_US.js';
...
export const getAntdLocale = async (lang?: string) => {
  ...
  const loadLocale = antdLocaleLoaders[localePath] ?? antdLocaleLoaders[FALLBACK_ANTD_LOCALE];
