export default {
  ...
  'betterAuth.errors.otpExpired': 'The verification code has expired. Please request a new one',
  'betterAuth.errors.otpInvalid': 'Invalid verification code',
  'betterAuth.errors.otpRequired': 'Please enter the verification code',
  'betterAuth.errors.otpTooManyAttempts': 'Too many incorrect attempts. Please request a new code',
  'betterAuth.errors.phoneInvalid': 'Please enter a valid mainland China phone number',
  'betterAuth.errors.phoneExists':
    'This phone number is already registered. Please sign in instead',
  'betterAuth.errors.phoneNotRegistered': 'This phone number is not registered yet',
  'betterAuth.errors.phoneRequired': 'Please enter your phone number',
  ...
  'betterAuth.signin.changePhone': 'Change phone number',
  ...
  'betterAuth.signin.phoneCodeError': 'Failed to send verification code',
  'betterAuth.signin.phoneCodePlaceholder': 'Enter verification code',
  'betterAuth.signin.phoneCodeSent': 'Verification code sent',
  'betterAuth.signin.phoneContinue': 'Next',
  'betterAuth.signin.phonePlaceholder': 'Enter mainland China phone number',
  'betterAuth.signin.phonePassword.subtitle': 'Enter your password to sign in',
  'betterAuth.signin.phonePasswordPlaceholder': 'Enter your password',
  'betterAuth.signin.phoneStep.subtitle': 'Sign in or sign up with a mobile verification code',
  'betterAuth.signin.phoneVerify.subtitle': 'Enter the verification code sent to your phone',
  'betterAuth.signin.phoneVerifyError': 'Failed to verify phone code',
  'betterAuth.signin.resendIn': 'You can resend in {{seconds}}s',
  'betterAuth.signin.sendCode': 'Send code',
  ...
  'betterAuth.signin.submitPhoneCode': 'Verify and sign in',
  'betterAuth.signin.submitPhonePassword': 'Sign in with password',
  'betterAuth.signin.useEmail': 'Use email',
  'betterAuth.signin.useEmailOrUsername': 'Use email or username',
  'betterAuth.signin.usePhone': 'Use phone number',
  'betterAuth.signin.usePhoneCode': 'Use verification code',
  'betterAuth.signin.usePhonePassword': 'Use password',
  ...
  'betterAuth.signup.submitPhoneCode': 'Verify and sign up',
  'betterAuth.signup.phoneProfile.subtitle':
    'Set your username and password to finish registration',
  ...
  'usage.quota.viewUsage': 'View Usage',
  'usage.quota.warning': 'Usage has reached {{percent}}%, please be mindful.',
  'usage.modelAccess.count': 'Authorized Models',
  'usage.modelAccess.edit': 'Edit Access',
  'usage.modelAccess.field': 'Model Access List',
  'usage.modelAccess.format': 'One per line: provider/model',
  'usage.modelAccess.title': 'Model Access',
  ...
  'usage.table.pricing': 'Unit Price (In/Out)',
