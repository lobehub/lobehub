export default {
  ...
  'shareModal.link.permissionPublic': 'Public',
  'shareModal.link.permissionPublicSignin': 'Signin Required',
  'shareModal.link.permissionUpdated': 'Permission updated',
  'shareModal.link.privateHint': 'Only you can access this link',
  'shareModal.link.publicHint': 'Anyone with the link can view without signing in',
  'shareModal.link.publicSigninHint': 'Sign-in required to view',
