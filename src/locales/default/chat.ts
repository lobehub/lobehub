export default {
  ...
  'claudeCodeInstallGuide.reason': 'ChinnaHub could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'ChinnaHub could not start Codex: {{message}}',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of ChinnaHub. ChinnaHub is not responsible for any consequences arising from this shared content.',
  'stt.action': 'Voice Input',
  'stt.loading': 'Recognizing...',
  'stt.prettifying': 'Polishing...',
  'voice.call.action': 'Live voice conversation',
  'voice.call.end': 'End call',
  'voice.call.error.browser':
    'Browser speech recognition failed. Check microphone permissions and try again.',
  'voice.call.error.native': 'Native realtime voice connection failed.',
  'voice.call.error.providerUnavailable':
    'Native voice is not available for the selected provider yet. Use hybrid or browser mode to continue.',
  'voice.call.error.runtime': 'Voice turn failed. Please try again.',
  'voice.call.error.unsupportedBrowser':
    'This browser does not expose the speech recognition API required for browser voice calls.',
  'voice.call.mode.browser': 'Browser',
  'voice.call.mode.hybrid': 'Hybrid',
  'voice.call.mode.provider': 'Provider native',
  'voice.call.mute': 'Mute',
  'voice.call.nativeOpenAI.notice':
    'OpenAI realtime voice is connected directly through WebRTC. Browser transcript mirroring is not available in this mode.',
  'voice.call.provider.browser': 'Browser',
  'voice.call.provider.gemini': 'Gemini Live',
  'voice.call.provider.openai': 'OpenAI Realtime',
  'voice.call.provider.openrouter': 'OpenRouter Audio',
  'voice.call.provider.xai': 'Grok / xAI Voice',
  'voice.call.start': 'Start call',
  'voice.call.status.active': 'Connected',
  'voice.call.status.connecting': 'Connecting...',
  'voice.call.status.error': 'Needs attention',
  'voice.call.status.idle': 'Ready',
  'voice.call.status.listening': 'Listening...',
  'voice.call.status.processing': 'Processing...',
  'voice.call.status.speaking': 'Speaking...',
  'voice.call.title': 'Live Voice Conversation',
  'voice.call.transcript.assistant': 'Assistant',
  'voice.call.transcript.empty': 'Start speaking to see the live transcript here.',
  'voice.call.transcript.user': 'You',
  'voice.call.unavailable.desc': 'This input is not connected to a conversation runtime.',
  'voice.call.unavailable.title': 'Voice call unavailable here',
  'voice.call.unmute': 'Unmute',
  'voice.input.action': 'Speech to text',
  ...
  'taskList.unassignedHint': 'Chinna will run this task when no assignee is set',
