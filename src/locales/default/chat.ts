export default {
  ...
  'taskList.empty.createButton': 'Create a task',
  'taskList.empty.subtitle': 'Describe a task and let AI take it from there.',
  'taskList.empty.templateDivider': 'or start from a template',
  'taskList.empty.title': 'Where shall we begin?',
