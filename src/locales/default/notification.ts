export default {
  ...
  'agent_cron_job_failed_model_unavailable':
    'The model configured for "{{jobName}}" is no longer available. Update the model in the agent settings to resume future runs.',
  'agent_cron_job_failed_model_unavailable_title': 'Scheduled task failed: model unavailable',
  'agent_cron_job_failed_rate_limit':
    'Your scheduled task "{{jobName}}" hit a rate limit from the model provider. It will automatically try again on the next schedule.',
  'agent_cron_job_failed_rate_limit_title': 'Scheduled task throttled',
  ...
  'image_generation_completed_title': 'Image ready',
  ...
  'video_generation_completed_title': 'Video ready',
};
