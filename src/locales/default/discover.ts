export default {
  ...
  'createGuide.func1.title': 'Submit in nexumChat',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the nexumChat Community.',
  'footer.title': 'Share your creation on nexumChat Community today',
  ...
  'models.providerInfo.apiTooltip': 'nexumChat supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'nexumChat Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by nexumChat automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the nexumChat marketplace with one click.',
