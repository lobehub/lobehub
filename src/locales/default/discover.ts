export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@picturaai.sbs</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@picturaai.sbs</email>.',
