export default {
  ...
  'channel.dingtalk.description': 'Connect this assistant to DingTalk for private and group chats.',
  'channel.dingtalk.appKeyHint': 'App Key from DingTalk Open Platform.',
  'channel.dingtalk.verificationTokenHint': 'Used to confirm DingTalk webhook events originate from your bot.',
  'channel.dingtalk.aesKey': 'AES Encryption Key',
  'channel.dingtalk.aesKeyHint': 'Required to decrypt DingTalk encrypted callbacks.',
  'channel.dingtalk.messageType': 'Message Format',
  'channel.dingtalk.messageTypeHint': 'Markdown keeps formatting; Text sends plain replies.',
  'channel.dingtalk.messageTypeMarkdown': 'Markdown',
  'channel.dingtalk.messageTypeText': 'Plain Text',
