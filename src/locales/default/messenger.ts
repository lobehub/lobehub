export default {
  ...
  'verify.confirm.relink.description':
    'This LobeHub account is already linked to Telegram account {{account}}. To link a different Telegram account, disconnect the current one first in Settings → Messenger.',
  'verify.confirm.relink.manage': 'Open Messenger settings',
  'verify.confirm.relink.title': 'Another Telegram account is already linked',
  ...
  'verify.error.unlinkBeforeRelink':
    'This LobeHub account is already linked to another Telegram account. Disconnect it in Settings → Messenger before linking a new one.',
