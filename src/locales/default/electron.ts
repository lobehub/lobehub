export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote nexumChat server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'nexumChat Cloud',
