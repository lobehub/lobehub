export default {
  ...
  'gateway.statusConnected': 'Device is connected to the cloud',
  'gateway.statusConnecting': 'Connecting to the cloud...',
  'gateway.statusDisconnected': 'Device is not connected',
