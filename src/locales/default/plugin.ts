export default {
  ...
  'builtins.lobe-group-management.apiName.executeTasks': 'Execute parallel tasks',
  ...
  'builtins.lobe-group-management.inspector.executeTasks.title': 'Assigning tasks to:',
