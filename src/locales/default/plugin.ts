export default {
  ...
  'builtins.lobe-personal-pages.actions.copy': 'Copy',
  'builtins.lobe-personal-pages.actions.open': 'Open page',
  'builtins.lobe-personal-pages.apiName.createPage': 'Create page',
  'builtins.lobe-personal-pages.apiName.listPages': 'List pages',
  'builtins.lobe-personal-pages.apiName.modifyNodes': 'Modify page',
  'builtins.lobe-personal-pages.apiName.readPage': 'Read page',
  'builtins.lobe-personal-pages.apiName.replaceContent': 'Replace page content',
  'builtins.lobe-personal-pages.inspector.chars': '{{count}} chars',
  'builtins.lobe-personal-pages.inspector.opsCount': '{{count}} ops',
  'builtins.lobe-personal-pages.inspector.opsResult': '{{success}}/{{total}} ops',
  'builtins.lobe-personal-pages.inspector.pageCount': '{{count}} pages',
  'builtins.lobe-personal-pages.title': 'Personal Pages',
