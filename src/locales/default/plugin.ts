export default {
  ...
  'protocolInstall.official.badge': 'ChinnaHub Official Skill',
  'protocolInstall.official.description':
    'Official ChinnaHub Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. ChinnaHub does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to Chinna',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'ChinnaHub Skills',
