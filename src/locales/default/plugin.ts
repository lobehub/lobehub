export default {
  ...
  'builtins.lobe-credentials.apiName.deleteCredential': 'Delete credential',
  'builtins.lobe-credentials.apiName.getCredential': 'Get credential',
  'builtins.lobe-credentials.apiName.listCredentials': 'List credentials',
  'builtins.lobe-credentials.apiName.setCredential': 'Set credential',
  'builtins.lobe-credentials.ui.card.description':
    'Manage credentials with explicit UI controls in ToolUI',
  'builtins.lobe-credentials.ui.card.title': 'Credential manager',
  'builtins.lobe-credentials.ui.clear': 'Clear',
  'builtins.lobe-credentials.ui.cancel': 'Cancel',
  'builtins.lobe-credentials.ui.confirmDelete':
    'Delete credential at {{path}}? This action cannot be undone.',
  'builtins.lobe-credentials.ui.confirmReveal':
    'Reveal plaintext for {{path}}? It will be masked again in 15 seconds.',
  'builtins.lobe-credentials.ui.delete': 'Delete',
  'builtins.lobe-credentials.ui.editorTitle': 'Set or update credential',
  'builtins.lobe-credentials.ui.empty': 'No credentials',
  'builtins.lobe-credentials.ui.hide': 'Hide',
  'builtins.lobe-credentials.ui.listTitle': 'Credentials ({{count}})',
  'builtins.lobe-credentials.ui.managerTitle': 'Filter credentials',
  'builtins.lobe-credentials.ui.openManager': 'Open credential manager',
  'builtins.lobe-credentials.ui.pathPlaceholder': 'Dot path (e.g. moltbook.apiKey)',
  'builtins.lobe-credentials.ui.prefixPlaceholder': 'Filter by prefix (optional)',
  'builtins.lobe-credentials.ui.reveal': 'Reveal',
  'builtins.lobe-credentials.ui.save': 'Save credential',
  'builtins.lobe-credentials.ui.setTitle': 'Set credential',
  'builtins.lobe-credentials.ui.toast.deleteNoop': 'Credential not found at {{path}}',
  'builtins.lobe-credentials.ui.toast.deleted': 'Credential deleted at {{path}}',
  'builtins.lobe-credentials.ui.toast.persistFailed': 'Failed to persist credentials: {{reason}}',
  'builtins.lobe-credentials.ui.toast.saved': 'Credential saved at {{path}}',
  'builtins.lobe-credentials.ui.toast.updated': 'Credential updated at {{path}}',
  'builtins.lobe-credentials.ui.update': 'Update',
  'builtins.lobe-credentials.ui.validation.emptyValue': 'Credential value cannot be empty',
  'builtins.lobe-credentials.ui.validation.invalidPath':
    'Invalid path. Use dot path with letters, numbers, underscore, or hyphen.',
  'builtins.lobe-credentials.ui.validation.pathExists':
    'Path already exists. Update it in the credentials tab.',
  'builtins.lobe-credentials.ui.valuePlaceholder': 'Credential value',
  'builtins.lobe-credentials.title': 'Credentials',
  ...
  'builtins.lobe-scheduled-task.apiName.deleteScheduledTask': 'Delete Scheduled Task',
  'builtins.lobe-scheduled-task.apiName.getScheduledTask': 'Get Scheduled Task',
  'builtins.lobe-scheduled-task.apiName.listScheduledTasks': 'List Scheduled Tasks',
  'builtins.lobe-scheduled-task.apiName.setScheduledTask': 'Set Scheduled Task',
  'builtins.lobe-scheduled-task.title': 'Scheduled Tasks',
