export default {
  ...
  'builtins.lobe-agent.apiName.generateVerifyPlan': 'Create automated checks',
  ...
  'builtins.lobe-agent.verifyPlan.optional': 'Optional',
  'builtins.lobe-agent.verifyPlan.portal.fields.description': 'Summary',
  ...
  'builtins.lobe-agent.verifyPlan.portal.verifier.agent.title': 'Agent check',
  'builtins.lobe-agent.verifyPlan.portal.verifier.llm.desc':
    'Judge against the text result and the run context.',
  'builtins.lobe-agent.verifyPlan.portal.verifier.llm.title': 'LLM judgment',
  'builtins.lobe-agent.verifyPlan.portal.verifier.program.desc':
    'Validate via commands, APIs or status results. Good for tests, type-check, PR existence.',
  'builtins.lobe-agent.verifyPlan.portal.verifier.program.title': 'Program check',
  'builtins.lobe-agent.verifyPlan.portal.verifier.title': 'Verification method',
  'builtins.lobe-agent.verifyPlan.required': 'Required',
