export default {
  ...
  'dev.mcp.oauth.connect': 'Connect with {{provider}}',
  'dev.mcp.oauth.connectFailed': 'Connect failed',
  'dev.mcp.oauth.connected': 'Connected',
  'dev.mcp.oauth.desc': 'Connect with the provider to authorize this MCP.',
  'dev.mcp.oauth.reconnect': 'Reconnect',
