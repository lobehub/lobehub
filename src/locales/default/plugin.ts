export default {
  ...
  'protocolInstall.official.badge': 'nexumChat Official Skill',
  'protocolInstall.official.description': 'Official nexumChat Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. nexumChat does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'nexumChat Skills',
