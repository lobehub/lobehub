export default {
  ...
  'credits.autoTopUp.monthlyLimit': 'Monthly payment limit',
  'credits.autoTopUp.monthlyLimitDesc':
    'Maximum amount auto top-up can charge per month. Leave empty for no limit',
  'credits.autoTopUp.monthlyTopUpAmount': 'Paid this month',
  ...
  'credits.autoTopUp.targetBalance': 'Top up balance to',
  'credits.autoTopUp.targetBalanceDesc': 'Auto top-up restores your credit balance to this amount',
  'credits.autoTopUp.threshold': 'Top up when balance is below',
  'credits.autoTopUp.thresholdDesc':
    'Auto top-up triggers when your credit balance falls to or below this amount',
  ...
  'credits.autoTopUp.validation.targetMustExceedThreshold':
    'The restored balance must be greater than the trigger balance',
