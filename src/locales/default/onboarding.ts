export default {
  'back': 'Back',
  'finish': 'Get Started',
  'interests.area.admin': 'Administration Dept.',
  'interests.area.automation': 'Automation Dept.',
  'interests.area.ceo_office': 'CEO Office',
  'interests.area.creative': 'Creative Vision Center',
  'interests.area.domestic_sales': 'Domestic Sales Division',
  'interests.area.finance': 'Finance Center',
  'interests.area.hr': 'Human Resources Dept.',
  'interests.area.infrastructure': 'Infrastructure Office',
  'interests.area.intl_sales': 'International Sales Division',
  'interests.area.it': 'IT Center',
  'interests.area.manufacturing': 'Manufacturing Center',
  'interests.area.odm': 'ODM Global Procurement Center',
  'interests.area.overseas_brand': 'Overseas Brand Division',
  'interests.area.overseas_warehouse': 'Overseas Warehouse Division',
  'interests.area.president_office': 'President Office',
  'interests.area.product': 'Product Management Center',
  'interests.area.quality': 'Quality Center',
  'interests.area.rd': 'R&D Center',
  'interests.area.risk_control': 'Risk Control / Internal Audit',
  'interests.area.robot': 'Loctek Robotics Research Institute',
  'interests.area.secretary': 'Board Secretary Office',
  'interests.area.smart_research': 'Smart Research Institute',
  'interests.area.supply_4': '4 Supply',
  'interests.area.other': 'Other',
  'interests.area.supply_chain': 'Supply Chain Center',
  'interests.hint': 'You can change this anytime in settings',
  'interests.placeholder': 'Enter your department...',
  'interests.title': 'Which department are you in?',
  'interests.title2': 'This helps me serve you better',
  'interests.title3': 'Select your department to get started~',
