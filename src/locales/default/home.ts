export default {
  ...
  'recommendations.heteroAgent.description':
    'Detected the {{name}} CLI on this device — add an agent to chat with it from LobeHub.',
  'recommendations.heteroAgent.tag': 'Local CLI',
  'recommendations.heteroAgent.title': 'Add {{name}} agent',
  'recommendations.subtitle': 'Recommended actions for your setup',
