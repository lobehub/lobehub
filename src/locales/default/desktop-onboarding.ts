export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using nexumChat Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve nexumChat. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve nexumChat',
  ...
  'screen5.actions.signInCloud': 'Sign in to nexumChat Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your nexumChat Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'nexumChat Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own nexumChat server instance',
