export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve ChinnaHub. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve ChinnaHub',
  ...
  'screen5.actions.signInCloud': 'Sign in to ChinnaHub Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your ChinnaHub Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'ChinnaHub Cloud',
