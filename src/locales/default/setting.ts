export default {
  ...
  'settingSystemTools.appEnvironment.chrome': 'Chrome',
  'settingSystemTools.appEnvironment.chrome.desc': 'Chromium browser engine version',
  'settingSystemTools.appEnvironment.desc': 'Built-in runtime versions in the desktop app',
  'settingSystemTools.appEnvironment.electron': 'Electron',
  'settingSystemTools.appEnvironment.electron.desc': 'Electron framework version',
  'settingSystemTools.appEnvironment.node': 'Node.js',
