...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tab.sharedAgents': 'Shared Agents',
  'sharedAgents.actions': 'Actions',
  'sharedAgents.avatar': 'Avatar',
  'sharedAgents.create': 'Create',
  'sharedAgents.createTitle': 'Create Shared Agent',
  'sharedAgents.delete': 'Delete',
  'sharedAgents.description': 'Description',
  'sharedAgents.edit': 'Edit',
  'sharedAgents.editTitle': 'Edit Shared Agent',
  'sharedAgents.enabled': 'Enabled',
  'sharedAgents.model': 'Model',
  'sharedAgents.provider': 'Provider',
  'sharedAgents.sort': 'Sort',
  'sharedAgents.systemRole': 'System Prompt',
  'sharedAgents.title': 'Name',
  'tab.skill': 'Skills',
