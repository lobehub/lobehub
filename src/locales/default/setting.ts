...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'systemAgent.inputCompletion.title': 'Input Auto-Completion',
  'systemAgent.promptRewrite.label': 'Model',
  'systemAgent.promptRewrite.modelDesc': 'Model used to rewrite prompts',
  'systemAgent.promptRewrite.title': 'Prompt Rewrite',
