export default {
  ...
  'accountDeletion.confirmCheckbox': 'I understand this action is irreversible',
  'accountDeletion.confirmContent':
    'Your account will be scheduled for deletion. You have 72 hours to cancel this request.',
  ...
  'accountDeletion.pendingMessage': 'Your account will be deleted {{time}}',
