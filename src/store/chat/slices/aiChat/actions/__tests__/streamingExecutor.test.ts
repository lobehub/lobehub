...
describe('StreamingExecutor actions', () => {
  ...
  // Skipped: internal_fetchAIChatMessage has been inlined into call_llm executor
  describe.skip('StreamingExecutor OptimisticUpdateContext isolation', () => {
  ...
  // Skipped: internal_fetchAIChatMessage has been inlined into call_llm executor
  describe.skip('content_part multimodal streaming', () => {
