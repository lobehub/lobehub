...
import { Button, Drawer, Flexbox, Icon, Input, Tag, Text } from '@lobehub/ui';
...
const DeviceDetailDrawer = memo<DeviceDetailDrawerProps>(({ device, isCurrent, onClose, open }) => {
    ...
    <Drawer
      ...
      footer={
        <Flexbox horizontal gap={8} justify={'flex-end'}>
          <Button onClick={onClose}>{t('devices.edit.cancel')}</Button>
      ...
      title={
        <Flexbox horizontal align={'center'} gap={8}>
          ...
          <Text ellipsis>{device.friendlyName || device.hostname || device.deviceId}</Text>
