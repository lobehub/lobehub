---
name: gortex-src-models-10-dirs
description: 'Work in the src/models +10 dirs area — 145 symbols across 14 files (88% cohesion)'
---
...
| File                                                                      | Symbols                                                                 |
| ------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `packages/database/src/models/agent.ts`                                   | agents, result.orderBy, result.orderBy, agents                          |
| `packages/database/src/models/topic.ts`                                   | buildTopicOrderBy, sortBy                                               |
| `packages/database/src/models/user.ts`                                    | fields, orderBy                                                         |
| `packages/database/src/models/userMemory/__tests__/query.test.ts`         | opts, createPreferencePair                                              |
| `packages/database/src/models/userMemory/model.ts`                        | params, buildTextSearchCondition                                        |
| `packages/database/src/models/userMemory/query.ts`                        | limit, query, limit, aggregateIdentityValueOptions, getSearchLimit, ... |
| `packages/database/src/schemas/_helpers.ts`                               | createdAt, updatedAt, name, timestamptz, accessedAt                     |
| `packages/database/src/schemas/userMemories/index.ts`                     | UserMemoryIdentitiesWithoutVectors                                      |
| `packages/memory-user-memory/src/providers/chatTopic.ts`                  | userId, buildContext                                                    |
...
| `src/store/page/slices/list/action.ts`                                    | document, documentItemToLobeDocument                                    |
...
```
get_communities with id: "community-997"
smart_context with task: "understand src/models +10 dirs", format: "gcx"
```
