...
| Building clickable actions with layout/text primitives | Use `Button` or `ActionIcon`; for icon+text actions, use `Button icon={...}` so spacing, hover/focus, and keyboard semantics stay consistent |
