...
├── README.md              # 本文档
├── crud.feature           # 侧边栏 CRUD 操作
├── editor-meta.feature    # 编辑器元数据（标题、Emoji）
├── editor-content.feature # 富文本编辑功能
└── copilot.feature        # Copilot 交互功能
```
...
BASE_URL=http://localhost:3006 \
  ...
  pnpm exec cucumber-js --config cucumber.config.js --tags "@page"
