...
Then('I should see the featured assistants section', async function (this: CustomWorld) {
  ...
  // Look for "Featured Assistants" heading text (Title component renders as h2)
  const featuredSection = this.page.getByRole('heading', { name: /featured assistants/i }).first();
...
Then('I should see the featured MCP tools section', async function (this: CustomWorld) {
  ...
  // Look for "Featured Tools" heading text (Title component renders as h2)
  const mcpSection = this.page.getByRole('heading', { name: /featured tools/i }).first();
