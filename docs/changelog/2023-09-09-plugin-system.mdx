...
description: >-
  ChinnaHub now supports a plugin ecosystem that lets Agents access real-time
...
ChinnaHub now supports plugins that extend what your Agents can do. Instead of being limited to built-in capabilities, Agents can now pull live data, interact with external platforms, and handle specialized workflows through community-built extensions.
...
Alongside plugin capabilities, ChinnaHub now offers quality voice synthesis options including OpenAI Audio and Microsoft Edge Speech. Choose a voice that matches your preference or scenario for more personalized interactions.
