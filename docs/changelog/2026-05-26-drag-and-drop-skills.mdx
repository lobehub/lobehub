---
title: Platform Agents, iMessage & Drag-Drop Skills
description: >-
  Run agents locally or on a remote device, chat through iMessage, and drop skills straight into the message box. v2.2.1 is here.
tags:
  - Platform Agents
  - iMessage
  - Skills
...
# Platform Agents, iMessage & Drag-Drop Skills

## Platform agents, local or remote
...
LobeHub now bridges to **iMessage** on desktop. Set up the BlueBubbles bridge from a clean connection card and start sending and receiving messages alongside your other bot channels.
