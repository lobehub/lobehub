...
- **New models.** Claude Fable 5 joins the Anthropic lineup, with new providers AntGroup, SenseNova (6.7 Flash Lite and U1 Fast), and updated Longcat models that fetch their list live. Model cards now show each model's knowledge cutoff, and the model tab bar stays visible.
