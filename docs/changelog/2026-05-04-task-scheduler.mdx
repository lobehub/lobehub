...
description: >-
  Delegate Claude Code and Codex from inside ChinnaHub, with a redesigned home, a
...
Now you can control coding agents in ChinnaHub. Simply click `Create Agent` and choose your coding agent. This feature is only available on desktop app.
