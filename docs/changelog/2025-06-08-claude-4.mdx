...
description: >-
  ChinnaHub introduces prompt variables for reusable templates and adds full
...
From May through June, ChinnaHub focused on making repeated workflows easier to run. Prompt variables let you reuse prompt structures with different inputs. Claude 4 support brings the latest reasoning capabilities with integrated web search. Expanded crawling and file handling round out the update.
...
@arvinxx @hezhijie0327 @chinnahub-team
