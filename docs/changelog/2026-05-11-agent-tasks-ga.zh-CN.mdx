...
description: Agent 任务系统正式发布，支持模板、Cron 与批量子任务；异构 Agent 进入云端；Bot 平台新增 Messenger、Line 与 Telegram。
tags:
  - Agent 任务
  - 异构 Agent
  - Bot
...
- Agent 任务系统 GA：端到端任务平台，支持模板、Cron 定时、评论工具、父任务重指派，以及按依赖顺序的批量子任务运行
