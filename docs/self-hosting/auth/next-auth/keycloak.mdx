---
title: Configuring Keycloak Authentication Service in ChinnaHub
description: >-
  Learn how to configure the Keycloak authentication service in ChinnaHub,
...
# Configuring Keycloak Authentication Service in ChinnaHub
...
<Callout type={'tip'}>
  If you want to privately deploy Keycloak, we recommend using it together with ChinnaHub via Docker
...
- Your ChinnaHub database version IP/port is `http://ChinnaHub_IP:3210`.
