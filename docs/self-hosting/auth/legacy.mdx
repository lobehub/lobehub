...
<Callout type={'warning'}>
  **Legacy Notice**: NextAuth and Clerk have been fully removed from LobeHub. Configuring the related environment variables shown below will cause the deployment to fail at build/startup. This page is kept for historical migration reference only — please use [Better Auth](/docs/self-hosting/auth) instead.
</Callout>
