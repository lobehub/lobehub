...
| `NEXT_PUBLIC_AUTH_URL` | Deprecated | No longer needed — the auth base URL is now automatically detected from request headers. Setting this variable will cause the deployment to fail. |
