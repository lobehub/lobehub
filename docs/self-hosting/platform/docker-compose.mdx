...
<Steps>
  ...
  <Callout type="tip">
    **Single Domain Deployment**
    ...
    The difference between Port Mode and Domain Mode is that Port Mode allows you to configure custom ports, while Domain Mode uses the default ports with a domain name.
