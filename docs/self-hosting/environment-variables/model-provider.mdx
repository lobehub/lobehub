...
- Type: Optional
- Description: The base URL used to access Xiaomi MiMo. Configure this option when using a proxy or a custom OpenAI-compatible endpoint.
...
- Default: `-`
- Example: `-all,+mimo-v2.5-pro,+mimo-v2.5=MiMo V2.5,+mimo-v2-flash=MiMo V2 Flash`
