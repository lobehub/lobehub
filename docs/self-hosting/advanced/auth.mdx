...
description: >-
  Learn how to configure Better Auth for centralized user authorization management. Supported SSO providers include Google, GitHub, Microsoft, and more.
...
Better Auth supports built-in providers (Google, GitHub, Microsoft, AWS Cognito) and Generic OIDC providers (Auth0, Authelia, Authentik, Casdoor, Cloudflare Zero Trust, Keycloak, Logto, Okta, ZITADEL, Feishu, WeChat).

### I'm using NextAuth/Clerk, do I need to migrate?

If your deployment is running fine, you can continue using your current authentication method. We are developing migration tools for users who want to switch to Better Auth. For progress updates, please follow [GitHub Issue #10456](https://github.com/lobehub/lobe-chat/issues/10456).
