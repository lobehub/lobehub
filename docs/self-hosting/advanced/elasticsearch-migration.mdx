...
The package command bundles the worker and executes it on Node.js. Do not invoke the TypeScript
entrypoint with Bun: production-size document batches can retain unbounded resident memory there.
