...
<Steps>
  ...
  Follow the [Quickstart](/docs/usage/getting-started/lobe-ai) to start your first conversation with Chinna. No setup needed.
...
<Cards>
  ...
  <Card href={'/docs/usage/getting-started/lobe-ai'} title={'Try Chinna'} />
</Cards>
