...
<Callout type={'tip'}>
  ...
  One of LobeChat’s standout features is its robust automated internationalization (i18n) workflow, which seamlessly translates your assistant into multiple languages. This ensures that users around the world can enjoy your assistant without language barriers.
</Callout>
