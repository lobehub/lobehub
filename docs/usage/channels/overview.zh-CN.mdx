...
description: >-
  ...
  Lark、钉钉，让用户可以直接在他们喜欢的聊天应用中与 AI 助手互动。
tags:
  - 渠道
  - 消息渠道
  - 集成
...
| [钉钉](/docs/usage/channels/dingtalk)       | 连接到钉钉企业内部应用机器人，用于私聊和群内 @ 触发对话      |
...
- **同时支持多个渠道** — 单个代理可以同时连接到 Discord、Slack、Telegram、QQ、微信、飞书、Lark 和钉钉。LobeHub 会自动将消息路由到正确的代理。
...
2. 选择一个平台并按照设置指南操作：
   ...
   - [钉钉](/docs/usage/channels/dingtalk)
...
| 功能        | Discord | Slack | Telegram | QQ | 微信 | 飞书   | Lark | 钉钉 |
| --------- | ------- | ----- | -------- | -- | -- | ---- | ---- | -- |
| 文本消息      | 是       | 是     | 是        | 是  | 是  | 是    | 是    | 是  |
| 私人消息      | 是       | 是     | 是        | 是  | 是  | 是    | 是    | 是  |
| 群组聊天      | 是       | 是     | 是        | 是  | 是  | 是    | 是    | 是  |
| 表情反应      | 是       | 是     | 是        | 否  | 否  | 部分支持 | 部分支持 | 否  |
| 图片 / 文件附件 | 是       | 是     | 是        | 是  | 否  | 是    | 是    | 否  |
