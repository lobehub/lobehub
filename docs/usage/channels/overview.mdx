...
| [Matrix](/docs/usage/channels/matrix)      | Connect to any Matrix homeserver (matrix.org, Synapse, Dendrite, Conduit) for rooms and DMs   |
...
2. Choose a platform and follow the setup guide:
   ...
   - [Matrix](/docs/usage/channels/matrix)
...
| Feature                | Discord | Slack | Telegram | LINE    | QQ  | WeChat | Feishu  | Lark    | Matrix  |
| ---------------------- | ------- | ----- | -------- | ------- | --- | ------ | ------- | ------- | ------- |
...
| Reactions              | Yes     | Yes   | Yes      | No      | No  | No     | Partial | Partial | Partial |
| Image/file attachments | Yes     | Yes   | Yes      | Inbound | Yes | No     | Yes     | Yes     | Inbound |
