...
description: >-
  ...
  Slack, Telegram, QQ, WeChat, Feishu, Lark, and DingTalk, allowing users to
...
| [DingTalk (钉钉)](/docs/usage/channels/dingtalk) | Connect to DingTalk enterprise bots for private chats and mention-only group conversations |
...
- **Multiple channels simultaneously** — A single agent can be connected to Discord, Slack, Telegram, QQ, WeChat, Feishu, Lark, and DingTalk at the same time. LobeHub routes messages to the correct agent automatically.
...
2. Choose a platform and follow the setup guide:
   ...
   - [DingTalk (钉钉)](/docs/usage/channels/dingtalk)

## Feature Support

Text messages are supported across all platforms. Some features vary by platform:

| Feature                | Discord | Slack | Telegram | QQ  | WeChat | Feishu  | Lark    | DingTalk |
| ---------------------- | ------- | ----- | -------- | --- | ------ | ------- | ------- | -------- |
...
| Reactions              | Yes     | Yes   | Yes      | No  | No     | Partial | Partial | No       |
| Image/file attachments | Yes     | Yes   | Yes      | Yes | No     | Yes     | Yes     | No       |
