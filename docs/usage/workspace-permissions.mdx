...
| Manage visible Resources (pages, files, documents, and knowledge bases), including delete and restore |   ✅   |    ✅   |    ❌   |
...
- **Resource Manager exception:** members can create, edit, move, delete, and restore every visible page, file, document, folder, and knowledge base regardless of creator. Private and restricted visibility still defines what is visible. Transfer and visibility changes remain creator- or owner-only.
