...
description: >-
  ...
  LobeChat, including how to configure your preferred voice model.
tags:
  - LobeChat
  - Text-to-Speech
  - TTS
...
<Image alt={'TTS'} src={'https://file.rene.wang/lobehub/467951f5-ad65-498d-aea9-fca8f35a4314.png'} />

## Speech-to-Text (STT)

To input text using your voice, click the voice input option in the message box. LobeChat will convert your speech into text and insert it into the input field. Once you're done, you can send it directly to the AI.
