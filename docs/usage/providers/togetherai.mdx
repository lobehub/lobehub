---
title: Using the Together AI API Key in LobeChat
description: >-
  Learn how to configure and use the Together AI API key in LobeChat to start
...
This guide will walk you through how to use Together AI in LobeChat:
...
<Steps>
  ...
  <Image alt={'Get your Together AI API key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/fcdcda9b-8668-4eac-b5cb-04803a888e92'} />

  - If you didn’t save it, you can always view it later under the API Key section in the Settings menu

  <Image alt={'View your Together AI API key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/663335d0-fb37-4882-9c7f-ebbd53275644'} />
  ...
  <Image alt={'Enter your Together AI API key in LobeChat'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/0cc6c9b8-4688-472b-a80f-f84c5ebbc719'} />

  - Enable together.ai and paste in your API key
  - Choose a Together AI model for your assistant to start chatting

  <Image alt={'Select and use a Together AI model'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/34d92da4-783f-4f16-8c4a-9d8e9a03c8da'} />
...
And that’s it! You’re now ready to use Together AI models for conversations in LobeChat.
