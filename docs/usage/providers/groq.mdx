---
title: Using the Groq API Key in LobeChat
description: >-
  Learn how to obtain a GroqCloud API Key and configure Groq in LobeChat to
...
This guide will walk you through how to use Groq in LobeChat:
...
<Steps>
  ...
  ### Step 2: Configure Groq in LobeChat

  Go to `Settings` -> `AI Providers` in LobeChat, and find the configuration section for Groq. Paste the API Key you just obtained.

  <Image alt={'Groq Provider Settings'} height={274} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/88948a3a-6681-4a8d-9734-a464e09e4957'} />
</Steps>

Next, in the assistant’s model selection menu, choose a model supported by Groq to start experiencing Groq’s powerful performance in LobeChat.

<Video alt={'Select Groq Model'} src="https://github.com/lobehub/lobe-chat/assets/28616219/b6b8226b-183f-4249-8255-663a5e9f5af4" />
