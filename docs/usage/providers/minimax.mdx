---
title: Using the Minimax API Key in LobeChat
description: >-
  Learn how to configure and use the MiniMax AI model in LobeChat. This guide
...
This guide will walk you through how to use MiniMax in LobeChat:
...
<Steps>
  ...
  <Image alt={'Create a MiniMax API Key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/f6e46f1c-0ac9-42ae-8e83-ddb0cc6c5bf8'} />
  ...
  <Image alt={'Select MiniMax Model and Start Chatting'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/f7d59c7a-abd0-4ebd-8c72-ca10c47a0f1a'} />
...
You're all set! You can now start chatting with models powered by MiniMax in LobeChat.
