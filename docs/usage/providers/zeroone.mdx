---
title: Using the 01.AI API Key in LobeChat
description: >-
  Learn how to configure and use AI models provided by 01.AI (Zero One AI) in
  LobeChat. Get your API key, enter it in the settings, choose a model, and
...
<Image alt={'Using Zero One AI in LobeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/4485fbc3-c309-4c4e-83ee-cb82392307a1'} />
...
This guide will walk you through how to use 01.AI in LobeChat:
...
<Steps>
  ...
  <Image alt={'Create an API Key on 01.AI'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/72f165f4-d529-4f01-a3ac-163c66e5ea73'} />
  ...
  <Image alt={'Save Your API Key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/f892fe64-c734-4944-91ff-9916a41bd1c9'} />
  ...
  <Image alt={'Enter Your API Key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/f539d104-6d64-4cc7-8781-3b36b00d32d0'} />

  - Enable 01.AI and paste in your API key
  - Choose a model from 01.AI for your AI assistant to start chatting

  <Image alt={'Select a 01.AI Model and Start Chatting'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/8bf73498-4649-4c4d-a95b-b68447599781'} />
...
And that’s it! You’re now ready to use 01.AI’s models in LobeChat for intelligent conversations.
