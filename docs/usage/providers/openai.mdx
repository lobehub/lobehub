...
description: >-
  Learn how to configure and use your OpenAI API Key in LobeChat, supporting
...
This guide will walk you through how to use [OpenAI](https://openai.com/) in LobeChat:
...
'https://github-production-user-asset-6210df.s3.amazonaws.com/28616219/296255167-f2745f2b-f083-4ba8-bc78-9b558e0002de.png'
  ...
  <Image alt={'Enter your API key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa'} />

  - Paste your API key into the input field
  - Choose an OpenAI model for your AI assistant to start chatting

  <Image alt={'Select an OpenAI model and start chatting'} inStep src={'https://github.com/lobehub/lobe-chat/assets/17870709/ff7ebacf-27f0-42d7-810b-00314499a084'} />
...
That’s it! You’re now ready to use OpenAI models in LobeChat for conversations.
