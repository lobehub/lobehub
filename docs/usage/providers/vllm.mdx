...
description: >-
  Learn how to configure and use vLLM language models in LobeChat, obtain an API
...
This guide will walk you through how to use vLLM in LobeChat:
...
<Steps>
  ...
  - Open the `App Settings` panel in LobeChat
  - Under `AI Providers`, locate the `vLLM` configuration section

  <Image alt={'Enter vLLM API Key'} inStep src={'https://github.com/user-attachments/assets/669c68bf-3f85-4a6f-bb08-d0d7fb7f7417'} />
...
You're now ready to use vLLM-powered models in LobeChat for conversations.
