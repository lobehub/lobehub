...
description: Learn how to configure and use the AiHubMix provider in LobeChat
tags:
  - AiHubMix
...
AiHubMix is an AI model aggregation platform that offers access to a variety of AI models through a unified OpenAI-compatible API interface. This guide will help you set up the AiHubMix provider in LobeChat.
...
2. **Obtain an API Key**
   ...
   - Generate an API key for use with LobeChat
...
1. **Configure the API Key**
   ...
   - Restart your LobeChat instance

2. **Select a Model**
   - Go to LobeChat settings
...
3. **Start a Conversation**
   ...
   - Choose an AiHubMix model
   - Begin chatting

## Features

- **Multi-Model Access**: Access a variety of AI models through a single API
- **OpenAI Compatibility**: Uses the standard OpenAI API format
...
3. **Rate Limiting**
   - AiHubMix may impose rate limits based on your subscription plan
...
- Contact the AiHubMix support team for API-related inquiries
