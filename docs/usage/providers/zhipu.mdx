...
description: >-
  Learn how to configure and use Zhipu AI's API Key in LobeChat to start
  chatting with models provided by Zhipu AI.
tags:
  - Zhipu AI
  - ChatGLM
  - API Key
...
<Image alt={'Using Zhipu AI in LobeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/497e3b20-57ca-4963-b6f4-897c9710c16e'} />
...
This guide will walk you through how to use Zhipu AI in LobeChat:
...
<Steps>
  ...
  <Image alt={'Get your Zhipu AI API Key'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/6d6f2bc5-1407-471d-95a8-fb03193edbdb'} />
  ...
  <Image alt={'Enter your Zhipu AI API Key in LobeChat'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/2afffe79-1d37-423c-9363-f09605d5e640'} />

  - Enable Zhipu AI and paste in your API key
  - Choose a Zhipu AI model for your assistant to start chatting

  <Image alt={'Select and use a Zhipu AI model'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/b83da559-73d1-4734-87d5-5e22955a9da2'} />
...
And that’s it! You’re now ready to start chatting with models provided by Zhipu AI in LobeChat.
