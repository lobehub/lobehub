...
description: >-
  Learn how to configure and use Infini-AI's API Key in LobeChat to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into LobeChat.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in LobeChat

  - Open LobeChat and go to the "Settings" page
