...
description: >-
  Learn how to integrate and use the unified API of Vercel AI Gateway in
  LobeChat
tags:
  - LobeChat
  - Vercel AI Gateway
...
This guide will walk you through how to use Vercel AI Gateway within LobeChat.
...
That's it! You can now start chatting in LobeChat using models provided by Vercel AI Gateway.
