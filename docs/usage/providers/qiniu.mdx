---
title: Using Qiniu Cloud's Large Language Model API Key in LobeChat
description: >-
  Learn how to configure and use Qiniu Cloud's large language models in LobeChat
...
# Using Qiniu Cloud's Large Language Model in LobeChat

<Image alt={'Using Qiniu Cloud LLM in LobeChat'} cover src={'https://github.com/user-attachments/assets/3ad2655e-dd20-4534-bf6d-080b3677df86'} />
...
This guide will walk you through how to use Qiniu Cloud's large language models in LobeChat:
...
<Steps>
  ...
  ### Step 2: Configure Qiniu Cloud LLM Service in LobeChat
...
That's it! You're now ready to use Qiniu Cloud's large language models in LobeChat for intelligent conversations.
