---
title: Using Tongyi Qianwen API Key in LobeChat
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  LobeChat, offering powerful natural language understanding and generation
  capabilities.
tags:
  - LobeChat
  - Tongyi Qianwen
...
This guide will walk you through how to use Tongyi Qianwen in LobeChat:
...
<Steps>
  ...
  <Image alt={'Enable DashScope Service'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/4f8d0102-7ca7-4f23-b96f-3fc5cf2cd66e'} />
  ...
  <Image alt={'Select Qwen Model and Start Chatting'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/f4a23c2a-503e-4731-bc4d-922bce0b6039'} />
...
You’re all set! You can now start using Tongyi Qianwen’s models in LobeChat for intelligent conversations.
