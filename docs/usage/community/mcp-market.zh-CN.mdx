...
你可以将任何 MCP 兼容的服务器直接添加到 LobeHub，无需经过市场。详细操作步骤请参见[自定义 MCP](/zh/docs/usage/community/custom-plugin) 指南，或查看[技能管理](/zh/docs/usage/community/pulgin-development) 指南了解所有技能类型及管理方式。
