...
You can add any MCP-compatible server directly to LobeHub without going through the marketplace. See the [Custom MCP](/docs/usage/community/custom-plugin) guide for a step-by-step walkthrough, or the [Skill Management](/docs/usage/community/pulgin-development) guide for an overview of all skill types and how to manage them.
