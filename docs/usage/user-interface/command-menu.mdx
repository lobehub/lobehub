...
title: Command Menu
description: >-
  The Command Menu is the quick action center of LobeHub. Instantly accessible
  via keyboard shortcuts, it allows you to search and execute various actions
...
<Image alt={'Command Menu'} src={'https://file.rene.wang/lobehub/image-4.png'} />
...
<Image alt={'Command Menu Search and Navigation'} src={'https://github.com/user-attachments/assets/a1c82694-9b1b-4e52-8b58-bc5b59c2e0fd'} />
