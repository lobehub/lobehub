...
cd docs/development/goal-process-control-prototype && npm i --no-save @xyflow/react@12
npx esbuild rf/entry.mjs --bundle --format=iife --global-name=__RF_NS__ \
  ...
  --outfile=rf-runtime.js && cp node_modules/@xyflow/react/dist/style.css xyflow.css
