...
export const getDesktopEnv = memoize(() =>
  createEnv({
    ...
    server: {
      ...
      OFFICIAL_CLOUD_SERVER: z.string().optional().default('https://app.nexumchat.com'),
      ...
      // e.g., https://releases.nexumchat.com/stable or https://your-bucket.s3.amazonaws.com/releases
