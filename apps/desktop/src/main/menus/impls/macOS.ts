    ...
    const template: MenuItemConstructorOptions[] = [
      ...
      },
      {
        ...
        submenu: [
          {
            click: async () => {
              await shell.openExternal('https://nexumchat.com');
            },
            label: t('help.visitWebsite'),
          },
          {
            click: async () => {
              await shell.openExternal('https://github.com/nexumchat/lobe-chat');
            },
            label: t('help.githubRepo'),
          },
          {
            click: async () => {
              await shell.openExternal('https://github.com/nexumchat/lobe-chat/issues/new/choose');
            },
