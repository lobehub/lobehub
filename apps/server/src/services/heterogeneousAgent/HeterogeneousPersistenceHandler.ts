...
export class HeterogeneousPersistenceHandler {
   ...
   * fork a brand-new thread — the "excessive-subagent-creation" bug. `refreshMainStateFromDb`
   ...
   * duplicate thread for a spawn that already finished (the "exact-duplicate-thread"
