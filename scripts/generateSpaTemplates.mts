...
const workbenchHtmlFallbackPath = path.resolve(root, 'dist/workbench/index.html');
const resolvedWorkbenchHtmlPath = existsSync(workbenchHtmlPath)
  ? workbenchHtmlPath
  : workbenchHtmlFallbackPath;

if (existsSync(resolvedWorkbenchHtmlPath)) {
